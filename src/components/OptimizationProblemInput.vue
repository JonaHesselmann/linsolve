  ...
  setup() {
    ...
    const solveLP = async () => {
      try {
        ...
        lpContent = inputToLPInterface.generateLPFile(optimizationStore.$state.selectedOptimization,optimizationStore.getObjectiveFunction,optimizationStore.constraints,[""],"")

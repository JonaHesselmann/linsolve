...
function dl(aglp_get_col_prim,b){var c;if(a.Ua)if(c=Math.floor(b+.5),1E-5>=Math.abs(b-c))b=c;else return 2;if(a.c!=-t){c=a.Ua?1E-5:1E-5+1E-8*Math.abs(a.c);if(b<a.c-c)return 1;if(b<a.c+.001*c)return a.f=a.c,0}if(a.f!=+t){c=a.Ua?1E-5:1E-5+1E-8*Math.abs(a.f);if(b>a.f+c)return 1;if(b>a.f-.001*c)return a.c=a.f,0}a.c=a.f=b;return 0}

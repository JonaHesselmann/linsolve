...
(function (exports) {
    ...
    function xa() {
        ...
        return d[e++].replace(
            ...
            function (f, g, k, h, l, n, m) {
                ...
                n
                    ? (n =
                        "*" == n ? +d[e++] : "*" == n.charAt(0) ? +d[n.slice(1, -1)] : +n)
    ...
    var Ba = (exports.glp_create_prob = function () {
        ...
        Ca = (exports.glp_set_prob_name = function (a, b) {
            ...
            null != c &&
            0 != c.reason &&
            x("glp_set_prob_name: operation not allowed");
            a.name = b;
        }),
        Da = (exports.glp_set_obj_name = function (a, b) {
            ...
            null != c &&
            0 != c.reason &&
            x("glp_set_obj_name: operation not allowed");
            a.ib = b;
        }),
        Fa = (exports.glp_set_obj_dir = function (a, b) {
            ...
            b != za &&
            b != Ea &&
            x("glp_set_obj_dir: dir = " + b + "; invalid direction flag");
            a.dir = b;
        }),
        ...
        Pa = (exports.glp_set_row_name = function (a, b, c) {
            (1 <= b && b <= a.h) ||
            x("glp_set_row_name: i = " + b + "; row number out of range");
            b = a.o[b];
        ...
        Qa = (exports.glp_set_col_name = function (a, b, c) {
            ...
            null != d &&
            0 != d.reason &&
            x("glp_set_col_name: operation not allowed");
            (1 <= b && b <= a.n) ||
            x("glp_set_col_name: j = " + b + "; column number out of range");
            b = a.g[b];
        ...
        Ua = (exports.glp_set_row_bnds = function (a, b, c, d, e) {
            (1 <= b && b <= a.h) ||
            x("glp_set_row_bnds: i = " + b + "; row number out of range");
            a = a.o[b];
            a.type = c;
            switch (c) {
                case Ka:
                ...
                case Q:
                    ...
                    a.stat != M &&
                    a.stat != P &&
                    (a.stat = Math.abs(d) <= Math.abs(e) ? M : P);
                    break;
                case C:
                    a.c = a.f = d;
                    a.stat != A && (a.stat = Na);
        ...
        Va = (exports.glp_set_col_bnds = function (a, b, c, d, e) {
            (1 <= b && b <= a.n) ||
            x("glp_set_col_bnds: j = " + b + "; column number out of range");
            a = a.g[b];
            a.type = c;
            switch (c) {
                case Ka:
        ...
        Xa = (exports.glp_set_obj_coef = function (a, b, c) {
            ...
            null != d &&
            0 != d.reason &&
            x("glp_set_obj_coef: operation not allowed");
            (0 <= b && b <= a.n) ||
            x("glp_set_obj_coef: j = " + b + "; column number out of range");
            0 == b ? (a.la = c) : (a.g[b].B = c);
        }),
        Ya = (exports.glp_set_mat_row = function (a, b, c, d, e) {
            var f, g, k;
            (1 <= b && b <= a.h) ||
            x("glp_set_mat_row: i = " + b + "; row number out of range");
        ...
        Za = (exports.glp_set_mat_col = function (a, b, c, d, e) {
            ...
            (1 <= b && b <= a.n) ||
            x("glp_set_mat_col: j = " + b + "; column number out of range");
    ...
    exports.glp_load_matrix = function (a, b, c, d, e) {
        ...
        5e8 < b &&
        x("glp_load_matrix: ne = " + b + "; too many constraint coefficients");
        for (l = 1; l <= b; l++)
            (h = c[l]),
                (k = d[l]),
            (1 <= h && h <= a.h) ||
    ...
    exports.glp_check_dup = function (a, b, c, d, e) {
        ...
        for (k = 1; k <= c; k++)
            if (((f = d[k]), (g = e[k]), !(1 <= f && f <= a && 1 <= g && g <= b)))
                return (a = -k);
        if (0 == a || 0 == b) return 0;
    ...
    var $a = (exports.glp_sort_matrix = function (a) {
            var b, c, d;
            (null != a && 3621377730 == a.Ad) ||
            x("glp_sort_matrix: P = " + a + "; invalid problem object");
        ...
        ab = (exports.glp_del_rows = function (a, b, c) {
            var d = a.$,
                ...
                g;
            (1 <= b && b <= a.h) ||
            x("glp_del_rows: nrs = " + b + "; invalid number of rows");
            for (g = 1; g <= b; g++)
                (f = c[g]),
                (1 <= f && f <= a.h) ||
                x(
                ...
                (d.reason != Ga &&
                d.reason != Ia &&
                x("glp_del_rows: operation not allowed"),
                e.level != d.R.level &&
                x(
                    "glp_del_rows: num[" +
                    g +
            ...
            b = 0;
            for (f = 1; f <= a.h; f++)
                (e = a.o[f]), 0 != e.ia && ((e.ia = ++b), (a.o[e.ia] = e));
            a.h = b;
            a.valid = 0;
        });
    exports.glp_del_cols = function (a, b, c) {
        ...
        (1 <= b && b <= a.n) ||
        x("glp_del_cols: ncs = " + b + "; invalid number of columns");
        for (f = 1; f <= b; f++)
            (d = c[f]),
            (1 <= d && d <= a.n) ||
            x(
        ...
        b = 0;
        for (d = 1; d <= a.n; d++)
            (e = a.g[d]), 0 != e.H && ((e.H = ++b), (a.g[e.H] = e));
        a.n = b;
        if (a.valid)
            for (c = a.h, e = a.head, d = 1; d <= b; d++)
                (f = a.g[d].bind), 0 != f && (e[f] = c + d);
    };
    var hb = (exports.glp_copy_prob = function (a, b, c) {
            ...
            a == b &&
            x("glp_copy_prob: copying problem object to itself not allowed");
            c != bb &&
            c != cb &&
            x("glp_copy_prob: names = " + c + "; invalid parameter");
            db(a);
    ...
    var ib = (exports.glp_get_obj_name = function (a) {
        ...
        mb = (exports.glp_get_row_name = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_get_row_name: i = " + b + "; row number out of range");
            return a.o[b].name;
        }),
        nb = (exports.glp_get_col_name = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_col_name: j = " + b + "; column number out of range");
            return a.g[b].name;
        }),
        pb = (exports.glp_get_row_type = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_get_row_type: i = " + b + "; row number out of range");
            return a.o[b].type;
        }),
        qb = (exports.glp_get_row_lb = function (a, b) {
            var c;
            (1 <= b && b <= a.h) ||
            x("glp_get_row_lb: i = " + b + "; row number out of range");
            switch (a.o[b].type) {
                case Ka:
                case Ta:
                    c = -t;
        ...
        rb = (exports.glp_get_row_ub = function (a, b) {
            var c;
            (1 <= b && b <= a.h) ||
            x("glp_get_row_ub: i = " + b + "; row number out of range");
            switch (a.o[b].type) {
                case Ka:
                case Sa:
                    c = +t;
        ...
        sb = (exports.glp_get_col_type = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_col_type: j = " + b + "; column number out of range");
            return a.g[b].type;
        }),
        tb = (exports.glp_get_col_lb = function (a, b) {
            var c;
            (1 <= b && b <= a.n) ||
            x("glp_get_col_lb: j = " + b + "; column number out of range");
            switch (a.g[b].type) {
                case Ka:
                case Ta:
                    c = -t;
        ...
        ub = (exports.glp_get_col_ub = function (a, b) {
            var c;
            (1 <= b && b <= a.n) ||
            x("glp_get_col_ub: j = " + b + "; column number out of range");
            switch (a.g[b].type) {
                case Ka:
                case Sa:
                    c = +t;
    ...
    exports.glp_get_obj_coef = function (a, b) {
        (0 <= b && b <= a.n) ||
        x("glp_get_obj_coef: j = " + b + "; column number out of range");
    ...
    var vb = (exports.glp_get_mat_row = function (a, b, c, d) {
            var e;
            (1 <= b && b <= a.h) ||
            x("glp_get_mat_row: i = " + b + "; row number out of range");
            e = 0;
            for (a = a.o[b].l; null != a; a = a.G)
                e++, null != c && (c[e] = a.g.H), null != d && (d[e] = a.j);
            return e;
        }),
        gb = (exports.glp_get_mat_col = function (a, b, c, d) {
            var e;
            (1 <= b && b <= a.n) ||
            x("glp_get_mat_col: j = " + b + "; column number out of range");
            e = 0;
            for (a = a.g[b].l; null != a; a = a.L)
                e++, null != c && (c[e] = a.o.ia), null != d && (d[e] = a.j);
            return e;
        }),
        wb = (exports.glp_create_index = function (a) {
            var b, c;
            if (null == a.gc)
                for (a.gc = {}, c = 1; c <= a.h; c++)
                    (b = a.o[c]), null != b.name && (a.gc[b.name] = b);
            if (null == a.Kc)
                for (a.Kc = {}, c = 1; c <= a.n; c++)
                    (b = a.g[c]), null != b.name && (a.Kc[b.name] = b);
        }),
        ...
        Ab = (exports.glp_set_rii = function (a, b, c) {
            (1 <= b && b <= a.h) ||
            x("glp_set_rii: i = " + b + "; row number out of range");
            0 >= c &&
            x("glp_set_rii: i = " + b + "; rii = " + c + "; invalid scale factor");
        ...
        Bb = (exports.glp_set_sjj = function (a, b, c) {
            (1 <= b && b <= a.n) ||
            x("glp_set_sjj: j = " + b + "; column number out of range");
            0 >= c &&
            x("glp_set_sjj: j = " + b + "; sjj = " + c + "; invalid scale factor");
            a.valid && a.g[b].za != c && a.g[b].stat == A && (a.valid = 0);
            a.g[b].za = c;
        }),
        Cb = (exports.glp_get_rii = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_get_rii: i = " + b + "; row number out of range");
            return a.o[b].qa;
        }),
        Db = (exports.glp_get_sjj = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_sjj: j = " + b + "; column number out of range");
            return a.g[b].za;
        }),
        ...
        Fb = (exports.glp_set_row_stat = function (a, b, c) {
            (1 <= b && b <= a.h) ||
            x("glp_set_row_stat: i = " + b + "; row number out of range");
            c != A &&
            c != M &&
            c != P &&
            c != Ra &&
        ...
        Gb = (exports.glp_set_col_stat = function (a, b, c) {
            (1 <= b && b <= a.n) ||
            x("glp_set_col_stat: j = " + b + "; column number out of range");
            c != A &&
            c != M &&
            c != P &&
            c != Ra &&
        ...
        Hb = (exports.glp_std_basis = function (a) {
            ...
            for (b = 1; b <= a.n; b++) {
                var c = a.g[b];
                c.type == Q && Math.abs(c.c) > Math.abs(c.f)
                    ? Gb(a, b, P)
                    : Gb(a, b, M);
            }
        }),
        sc = (exports.glp_simplex = function (a, b) {
                ...
                if (
                    ...
                    (c == Kb
                        ...
                        : c == Nb
                            ...
                            : c == Ob &&
                            b.s >= Mb &&
                            y("glp_simplex: initial basis is ill-conditioned")),
                    0 != c)
                )
                    return c;
                b.hb == Pb
            ...
            function e(a, b) {
                ...
                for (g = 1; g <= a.h; g++) {
                    ...
                    if (e.type == Sa || e.type == Q || e.type == C)
                        e.c > +b.Ib &&
                        ((a.ra = jc), 0 == a.some && b.hb != Pb && (a.some = g)),
                        p < +e.c && (p = +e.c);
                ...
                for (e = g = 1; e <= a.n; e++)
                    (f = a.g[e]), g < Math.abs(f.B) && (g = Math.abs(f.B));
                g = (a.dir == za ? 1 : -1) / g;
                for (e = 1; e <= a.n; e++) {
                    f = a.g[e];
                    f.type == Ka
                    ...
                    if (f.type == Ka || f.type == Sa)
                        g * f.M < -b.vb &&
                        ((a.wa = jc), 0 == a.some && b.hb == Pb && (a.some = a.h + e)),
                        u < -g * f.M && (u = -g * f.M);
            ...
            var f;
            (null != a && 3621377730 == a.Ad) ||
            x("glp_simplex: P = " + a + "; invalid problem object");
            ...
            b.hb != Rb &&
            b.hb != Ub &&
            x("glp_simplex: meth = " + b.hb + "; invalid parameter");
            b.ed != nc &&
            b.ed != oc &&
            x("glp_simplex: pricing = " + b.ed + "; invalid parameter");
            b.le != pc &&
            b.le != qc &&
            x("glp_simplex: r_test = " + b.le + "; invalid parameter");
            (0 < b.Ib && 1 > b.Ib) ||
            x("glp_simplex: tol_bnd = " + b.Ib + "; invalid parameter");
            (0 < b.vb && 1 > b.vb) ||
            x("glp_simplex: tol_dj = " + b.vb + "; invalid parameter");
            (0 < b.ve && 1 > b.ve) ||
            x("glp_simplex: tol_piv = " + b.ve + "; invalid parameter");
            ...
            b.yc != bb &&
            b.yc != cb &&
            x("glp_simplex: presolve = " + b.yc + "; invalid parameter");
            a.ra = a.wa = Aa;
            a.ea = 0;
            a.some = 0;
            for (f = 1; f <= a.h; f++) {
        ...
        zc = (exports.glp_get_row_stat = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_get_row_stat: i = " + b + "; row number out of range");
            return a.o[b].stat;
        }),
        Ac = (exports.glp_get_row_prim = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_get_row_prim: i = " + b + "; row number out of range");
            return a.o[b].w;
        }),
        Bc = (exports.glp_get_row_dual = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_get_row_dual: i = " + b + "; row number out of range");
            return a.o[b].M;
        }),
        Cc = (exports.glp_get_col_stat = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_col_stat: j = " + b + "; column number out of range");
            return a.g[b].stat;
        }),
        Dc = (exports.glp_get_col_prim = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_col_prim: j = " + b + "; column number out of range");
            return a.g[b].w;
        }),
        Ec = (exports.glp_get_col_dual = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_col_dual: j = " + b + "; column number out of range");
            return a.g[b].M;
        });
    ...
    var Hc = (exports.glp_set_col_kind = function (a, b, c) {
            (1 <= b && b <= a.n) ||
            x("glp_set_col_kind: j = " + b + "; column number out of range");
            var d = a.g[b];
            switch (c) {
                case Ma:
                    d.kind = Ma;
        ...
        Ic = (exports.glp_get_col_kind = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_get_col_kind: j = " + b + "; column number out of range");
            var c = a.g[b],
                d = c.kind;
            switch (d) {
                case Fc:
        ...
        Kc = (exports.glp_get_num_bin = function (a) {
            for (var b, c = 0, d = 1; d <= a.n; d++)
                (b = a.g[d]),
                b.kind == Fc && b.type == Q && 0 == b.c && 1 == b.f && c++;
            return c;
        });
    exports.glp_intopt = function (a, b) {
        function c(a, b) {
            ...
            0 == c
                ? a.Da == ec
                    ...
                    : (b.s >= Xb && y("PROBLEM HAS NO INTEGER FEASIBLE SOLUTION"),
                        (a.Da = jc))
                : c == Pc
                    ? b.s >= Xb &&
                    y("RELATIVE MIP GAP TOLERANCE REACHED; SEARCH TERMINATED")
                    : c == Qc
        ...
        function d(a, b) {
            ...
            (r == bc
                ...
                : r == cc &&
                b.s >= Xb &&
                y("LP RELAXATION HAS NO DUAL FEASIBLE SOLUTION"));
            if (0 != r) return r;
            m = Ba();
            dc(f, m);
            if (0 == m.h && 0 == m.n)
                return (
                    (m.Da = vc),
                        (m.xa = m.la),
                    b.s >= Xb &&
                    (y("Objective value = " + m.xa + ""),
                        y("INTEGER OPTIMAL SOLUTION FOUND BY MIP PREPROCESSOR")),
                        d()
                );
            if (b.s >= Xb) {
                var p = Jc(m),
            ...
            if (0 != r)
                return (
                    b.s >= Mb && y("glp_intopt: cannot solve LP relaxation"), (r = Tb)
                );
            r = xc(m);
        ...
        var e, f;
        (null != a && 3621377730 == a.Ad) ||
        x("glp_intopt: P = " + a + "; invalid problem object");
        ...
        (0 < b.Xb && 1 > b.Xb) ||
        x("glp_intopt: tol_int = " + b.Xb + "; invalid parameter");
        (0 < b.ue && 1 > b.ue) ||
        x("glp_intopt: tol_obj = " + b.ue + "; invalid parameter");
        ...
        (0 <= b.Ke && 256 >= b.Ke) ||
        x("glp_intopt: cb_size = " + b.Ke + "; invalid parameter");
        b.dd != hd &&
        b.dd != id &&
        b.dd != jd &&
        x("glp_intopt: pp_tech = " + b.dd + "; invalid parameter");
        ...
        b.yd != bb &&
        b.yd != cb &&
        x("glp_intopt: gmi_cuts = " + b.yd + "; invalid parameter");
        b.vd != bb &&
        b.vd != cb &&
        x("glp_intopt: cov_cuts = " + b.vd + "; invalid parameter");
        b.td != bb &&
        b.td != cb &&
        x("glp_intopt: clq_cuts = " + b.td + "; invalid parameter");
        b.yc != bb &&
        b.yc != cb &&
        x("glp_intopt: presolve = " + b.yc + "; invalid parameter");
        b.qd != bb &&
        b.qd != cb &&
        x("glp_intopt: binarize = " + b.qd + "; invalid parameter");
        b.Ve != bb &&
        b.Ve != cb &&
        x("glp_intopt: fp_heur = " + b.Ve + "; invalid parameter");
        a.Da = Aa;
        a.xa = 0;
        for (e = 1; e <= a.h; e++)
    ...
    var kd = (exports.glp_mip_row_val = function (a, b) {
            (1 <= b && b <= a.h) ||
            x("glp_mip_row_val: i = " + b + "; row number out of range");
            return a.o[b].Va;
        }),
        ld = (exports.glp_mip_col_val = function (a, b) {
            (1 <= b && b <= a.n) ||
            x("glp_mip_col_val: j = " + b + "; column number out of range");
            return a.g[b].Va;
        }),
        ...
        Jb = (exports.glp_factorize = function (a) {
            ...
            for (h = 1; h <= c + d; h++)
                if (
                    (h <= c
                        ? ((l = e[h].stat), (e[h].bind = 0))
                        : ((l = f[h - c].stat), (f[h - c].bind = 0)),
                    l == A)
                ) {
                    k++;
                    if (k > c) return (a = Kb);
    ...
    exports.glp_bf_updated = function (a) {
        0 == a.h ||
        a.valid ||
        x("glp_bf_update: basis factorization does not exist");
    ...
    var fb = (exports.glp_set_bfcp = function (a, b) {
            ...
            null == b
                ...
                0 > c.zd &&
                x("glp_set_bfcp: lu_size = " + c.zd + "; invalid parameter"),
                (0 < c.ec && 1 > c.ec) ||
                x("glp_set_bfcp: piv_tol = " + c.ec + "; invalid parameter"),
                1 > c.xc &&
                x("glp_set_bfcp: piv_lim = " + c.xc + "; invalid parameter"),
                c.hc != bb &&
                c.hc != cb &&
                x("glp_set_bfcp: suhl = " + c.hc + "; invalid parameter"),
                (0 <= c.Ob && 1e-6 >= c.Ob) ||
                x("glp_set_bfcp: eps_tol = " + c.Ob + "; invalid parameter"),
                1 > c.sc &&
                x("glp_set_bfcp: max_gro = " + c.sc + "; invalid parameter"),
                (1 <= c.Zc && 32767 >= c.Zc) ||
                x("glp_set_bfcp: nfs_max = " + c.Zc + "; invalid parameter"),
                (0 < c.jc && 1 > c.jc) ||
                x("glp_set_bfcp: upd_tol = " + c.jc + "; invalid parameter"),
                (1 <= c.vc && 32767 >= c.vc) ||
                x("glp_set_bfcp: nrs_max = " + c.vc + "; invalid parameter"),
                0 > c.jd &&
                x("glp_set_bfcp: rs_size = " + c.vc + "; invalid parameter"),
                0 == c.jd && (c.jd = 20 * c.vc));
            null != a.Y && nd(a);
        }),
        td = (exports.glp_get_bhead = function (a, b) {
            0 == a.h ||
            a.valid ||
            x("glp_get_bhead: basis factorization does not exist");
            (1 <= b && b <= a.h) ||
            x("glp_get_bhead: k = " + b + "; index out of range");
            return a.head[b];
        }),
        ud = (exports.glp_get_row_bind = function (a, b) {
            0 == a.h ||
            a.valid ||
            x("glp_get_row_bind: basis factorization does not exist");
            (1 <= b && b <= a.h) ||
            x("glp_get_row_bind: i = " + b + "; row number out of range");
            return a.o[b].bind;
        }),
        vd = (exports.glp_get_col_bind = function (a, b) {
            0 == a.h ||
            a.valid ||
            x("glp_get_col_bind: basis factorization does not exist");
            (1 <= b && b <= a.n) ||
            x("glp_get_col_bind: j = " + b + "; column number out of range");
            return a.g[b].bind;
        }),
        xd = (exports.glp_ftran = function (a, b) {
            ...
            0 < c && wd(a.Y, b);
            for (f = 1; f <= c; f++)
                (g = a.head[f]), (b[f] = g <= c ? b[f] / d[g].qa : b[f] * e[g - c].za);
        }),
    ...
    exports.glp_warm_up = function (a) {
        ...
        for (d = 1; d <= a.h; d++)
            if (((b = a.o[d]), b.stat == A)) {
                ...
                c = b.type;
                if (c == Sa || c == Q || c == C)
                    (f = 1e-6 + 1e-9 * Math.abs(b.c)), b.w < b.c - f && (a.ra = Ad);
                if (c == Ta || c == Q || c == C)
                    (f = 1e-6 + 1e-9 * Math.abs(b.f)), b.w > b.f + f && (a.ra = Ad);
            }
        for (d = 1; d <= a.n; d++)
            if (((b = a.g[d]), b.stat == A)) {
                b.w = e[b.bind];
    ...
    var Bd = (exports.glp_eval_tab_row = function (a, b, c, d) {
            ...
            0 == e ||
            a.valid ||
            x("glp_eval_tab_row: basis factorization does not exist");
            (1 <= b && b <= e + f) ||
            x("glp_eval_tab_row: k = " + b + "; variable number out of range");
        ...
        Cd = (exports.glp_eval_tab_col = function (a, b, c, d) {
            ...
            0 == e ||
            a.valid ||
            x("glp_eval_tab_col: basis factorization does not exist");
            (1 <= b && b <= e + f) ||
            x("glp_eval_tab_col: k = " + b + "; variable number out of range");
            (b <= e ? zc(a, b) : Cc(a, b - e)) == A &&
            x("glp_eval_tab_col: k = " + b + "; variable must be non-basic");
        ...
        Dd = (exports.glp_transform_row = function (a, b, c, d) {
            ...
            (0 <= b && b <= g) ||
            x("glp_transform_row: len = " + b + "; invalid row length");
            for (k = 1; k <= b; k++)
                (e = c[k]),
                (1 <= e && e <= g) ||
                x(
            ...
            b = 0;
            for (e = 1; e <= f; e++)
                zc(a, e) != A && ((n = -q[e]), 0 != n && (b++, (c[b] = e), (d[b] = n)));
    ...
    exports.glp_transform_col = function (a, b, c, d) {
        ...
        (0 <= b && b <= f) ||
        x("glp_transform_col: len = " + b + "; invalid column length");
        for (g = 1; g <= b; g++)
            (e = c[g]),
            (1 <= e && e <= f) ||
            x(
        ...
        b = 0;
        for (e = 1; e <= f; e++)
            0 != k[e] && (b++, (c[b] = td(a, e)), (d[b] = k[e]));
        return b;
    };
    var Ed = (exports.glp_prim_rtest = function (a, b, c, d, e, f) {
            var g, k, h, l, n, m, q, r, p, u, v, H, E;
            tc(a) != ec &&
            x("glp_prim_rtest: basic solution is not primal feasible ");
            1 != e &&
            -1 != e &&
            x("glp_prim_rtest: dir = " + e + "; invalid parameter");
            (0 < f && 1 > f) ||
            x("glp_prim_rtest: eps = " + f + "; invalid parameter");
            k = kb(a);
            h = lb(a);
            l = 0;
            E = t;
            ...
            for (n = 1; n <= b; n++)
                if (
                    ...
                    0 > H && (H = 0);
                    if (E > H || (E == H && r < Math.abs(g)))
                        (l = n), (E = H), (r = Math.abs(g));
                }
            return l;
        }),
        Fd = (exports.glp_dual_rtest = function (a, b, c, d, e, f) {
            ...
            1 != e &&
            -1 != e &&
            x("glp_dual_rtest: dir = " + e + "; invalid parameter");
            (0 < f && 1 > f) ||
            x("glp_dual_rtest: eps = " + f + "; invalid parameter");
            k = kb(a);
            h = lb(a);
            p = jb(a) == za ? 1 : -1;
            l = 0;
            ...
            for (n = 1; n <= b; n++) {
                ...
                0 > u && (u = 0);
                if (v > u || (v == u && q < Math.abs(g)))
                    (l = n), (v = u), (q = Math.abs(g));
            }
            return l;
        });
    function Gd(a, b, c, d, e, f, g) {
        var k,
            ...
            q;
        a.ra == Aa &&
        x("glp_analyze_row: primal basic solution components are undefined");
        a.wa != ec && x("glp_analyze_row: basic solution is not dual feasible");
        (0 <= b && b <= a.n) ||
        x("glp_analyze_row: len = " + b + "; invalid row length");
        q = 0;
        for (k = 1; k <= b; k++)
            (h = c[k]),
            (1 <= h && h <= a.h + a.n) ||
    ...
    exports.glp_analyze_bound = function (a, b, c) {
        ...
        r = p = u = v = null;
        (null != a && 3621377730 == a.Ad) ||
        x("glp_analyze_bound: P = " + a + "; invalid problem object");
        e = a.h;
        f = a.n;
        (a.ra == ec && a.wa == ec) ||
        x("glp_analyze_bound: optimal basic solution required");
        0 == e || a.valid || x("glp_analyze_bound: basis factorization required");
        (1 <= b && b <= e + f) ||
        x("glp_analyze_bound: k = " + b + "; variable number out of range");
        d = b <= e ? a.o[b] : a.g[b - e];
        g = d.stat;
        f = d.w;
        g == A &&
        x("glp_analyze_bound: k = " + b + "; basic variable not allowed ");
    ...
    exports.glp_analyze_coef = function (a, b, c) {
        var d,
            ...
            ba = null;
        (null != a && 3621377730 == a.Ad) ||
        x("glp_analyze_coef: P = " + a + "; invalid problem object");
        e = a.h;
        f = a.n;
        (a.ra == ec && a.wa == ec) ||
        x("glp_analyze_coef: optimal basic solution required");
        0 == e || a.valid || x("glp_analyze_coef: basis factorization required");
        (1 <= b && b <= e + f) ||
        x("glp_analyze_coef: k = " + b + "; variable number out of range");
        b <= e
        ...
        H = d.w;
        k != A &&
        x("glp_analyze_coef: k = " + b + "; non-basic variable not allowed");
    ...
    function Id(a, b, c, d, e, f, g) {
        ...
        h = { name: null };
        (0 <= b && 255 >= b) ||
        x("glp_ios_add_row: klass = " + b + "; invalid cut class");
        h.qc = b;
        h.l = null;
        (0 <= c && c <= a.n) ||
        x("glp_ios_add_row: len = " + c + "; invalid cut length");
        for (l = 1; l <= c; l++)
            (b = {}),
            (1 <= d[l] && d[l] <= a.n) ||
            x(
        ...
        f != Ta &&
        f != C &&
        x("glp_ios_add_row: type = " + f + "; invalid cut type");
        h.type = f;
        h.Zf = g;
        h.ga = k.$a;
        h.next = null;
    ...
    function Jd(a, b) {
        (1 <= b && b <= a.F.n) ||
        x("glp_ios_can_branch: j = " + b + "; column number out of range");
        return a.$c[b];
    }
    function Kd(a, b) {
        var c = a.F,
        ...
        for (e = 1; e <= d; e++)
            for (f = c.o[e], f.Va = 0, g = f.l; null != g; g = g.G)
                f.Va += g.j * g.g.Va;
        return 0;
    }
    ...
    exports.glp_mpl_postsolve = function (a, b, c) {
        ...
        c != le &&
        c != Sc &&
        x("glp_mpl_postsolve: sol = " + c + "; invalid parameter");
        e = Td(a);
        f = be(a);
        (e == kb(b) && f == lb(b)) ||
        x("glp_mpl_postsolve: wrong problem object\n");
        if (!me(a)) return 0;
        for (d = 1; d <= e; d++)
            c == $b
                ...
                : c == le
                    ? ((g = 0),
                        (k = glp_ipt_row_prim(b, d)),
                        (h = glp_ipt_row_dual(b, d)))
        ...
        for (d = 1; d <= f; d++)
            c == $b
                ...
                : c == le
                    ? ((g = 0),
                        (k = glp_ipt_col_prim(b, d)),
                        (h = glp_ipt_col_dual(b, d)))
    ...
    function od(a, b, c, d) {
        ...
        if (null != a.jb) {
            ...
            a: {
                ...
                (1 <= f && 32767 >= f) ||
                x("scf_create_it: n_max = " + f + "; invalid parameter"),
                    (g = {}),
                    (g.N = f),
                    (g.n = 0),
                ...
                c.n = c.ta = 0;
                for (f = 1; f <= b; f++)
                    (e.Ee[f] = e.De[f] = f), (e.Ge[f] = e.Fe[f] = f);
                e.md = 1;
                b = 0;
            }
            switch (b) {
    ...
    function wd(a, b) {
        if (null != a.jb) {
            ...
            for (r = 1; r <= k; r++)
                if (0 != g[r + d])
                    for (v = -1 * g[r + d], p = h[r], u = p + l[r]; p < u; p++)
                        g[n[p]] += v * q[p];
            Ie(c.ma, 0, g);
    ...
    function Me(a, b, c, d, e, f) {
        if (null != a.jb)
            ...
            a: {
                ...
                (1 <= b && b <= h) ||
                x("lpf_update_it: j = " + b + "; column number out of range");
                if (n == g.N) (g.valid = 0), (b = LPF_ELIMIT);
                    ...
                    m[n + 1] = B;
                    for (G = 1; G <= k; G++)
                        0 != O[G] && ((J[B] = G), (R[B] = O[G]), B++);
                    q[n + 1] = B - g.md;
                    g.md = B;
                    r[n + 1] = B;
                    for (G = 1; G <= k; G++)
                        0 != S[G] && ((J[B] = G), (R[B] = S[G]), B++);
                    p[n + 1] = B - g.md;
                    g.md = B;
                    Je(g, O, 0, O);
                    Le(g, S, 0, S);
                    ...
                    if (q == G) r = Re;
                        ...
                        B = 0;
                        ba = 1;
                        for (p = Se(m, ba, ba); ba <= O; ba++, p += G, G--)
                            0 != S[p] && B++;
                        m.ta = B;
                        m.ta != q && (r = Ve);
    ...
    var We = (exports.glp_read_lp = function (a, b, c) {
        ...
        function h(a) {
            function b() {
                for (a.b = 9; va(a.m) || 0 <= "!\"#$%&()/,.;?@_`'{}|~".indexOf(a.m); )
                    g(a);
                c &&
                (k(a.i, "minimize")
                    ? (a.b = 1)
                                ...
                                : k(a.i, "maximum")
                                    ...
                                    : k(a.i, "max")
                                        ...
                                        : k(a.i, "subject")
                                            ...
                                            d(
                                                a,
                                                "keyword `" + a.i + a.m + "...' not recognized",
                                            )))
                                            : k(a.i, "such")
                                                ? " " == a.m &&
                                                (f(a),
            ...
            for (a.value = 0; ; ) {
                ...
                if (-1 == a.m) a.b = 0;
                    ...
                    a.value = Number(a.i);
                    a.value == Number.NaN &&
                    d(a, "numeric constant `" + a.i + "' out of range");
                } else
                    "+" == a.m
                        ? ((a.b = 11), g(a))
                        : "-" == a.m
        ...
        function n(a) {
            for (var b, c = 0, e, f; ; )
                if (
                    ...
                    e = 0;
                    for (b = 1; b <= c; b++)
                        0 != a.j[b] && (e++, (a.ca[e] = a.ca[b]), (a.j[e] = a.j[b]));
                    break;
                }
            return e;
        }
        function m(a, b, c) {
            a.c[b] != +t &&
            e(a, "lower bound of variable `" + nb(a.Oa, b) + "' redefined");
            a.c[b] = c;
        }
        function q(a, b, c) {
            a.f[b] != -t &&
            e(a, "upper bound of variable `" + nb(a.Oa, b) + "' redefined");
            a.f[b] = c;
        }
        function r(a) {
            var b, c, e, f;
            for (h(a); 11 == a.b || 12 == a.b || 10 == a.b || 9 == a.b; )
                11 == a.b || 12 == a.b
                    ...
                    : 10 == a.b
                        ...
                        : (c = 0),
                c &&
                (14 != a.b && d(a, "missing `<', `<=', or `=<' after lower bound"),
                    h(a)),
                9 != a.b && d(a, "missing variable name"),
                    (b = l(a, a.i)),
                c && m(a, b, e),
                                    ...
                                    ? ((f = 11 == a.b ? 1 : -1),
                                        ...
                                        10 == a.b
                                            ...
                                            : k(a.i, "infinity") || 0 == k(a.i, "inf")
                                                ? (0 < f &&
                                                d(a, "invalid use of `+inf' as lower bound"),
                                                    m(a, b, -t),
                                                    h(a))
                                                : d(a, "missing lower bound"))
                                    : 10 == a.b
        ...
        function p(a) {
            ...
            5 == a.b
                ...
                : 6 == a.b
                    ...
                    : 7 == a.b && ((c = 1), h(a));
            for (; 9 == a.b; )
                (b = l(a, a.i)), Hc(a.Oa, b, Fc), c && (m(a, b, 0), q(a, b, 1)), h(a);
        }
        var u = {};
        ...
        (function (a) {
            ...
            for (
                ...
                (b = La(a.Oa, 1)),
                    9 == a.b && ":" == a.m
                        ? (0 != xb(a.Oa, a.i) &&
                        d(a, "constraint `" + a.i + "' multiply defined"),
                            Pa(a.Oa, b, a.i),
                            h(a),
                            h(a))
                        : Pa(a.Oa, b, "r." + a.count),
    ...
    function Ne(a, b, c, d, e, f) {
        ...
        (1 <= b && b <= g) ||
        x("fhv_update_it: j = " + b + "; column number out of range");
        ...
        c = 0;
        for (F = 1; F <= g; F++)
            (e = oa[F]), 0 == e || Math.abs(e) < T || (c++, (ba[c] = F), (oa[c] = e));
        Y = q[b];
        for (Z = Y + r[b] - 1; Y <= Z; Y++) {
            F = B[Y];
            f = h[F];
        ...
        for (D = 1; D <= c; D++) {
            F = ba[D];
            if (l[F] + 1 > n[F] && Xe(k, F, l[F] + 10))
                return (a.valid = 0), (k.Ya = k.Ka + k.Ka), (a = Qe);
            f = h[F] + l[F];
            B[f] = b;
            J[f] = oa[D];
            l[F]++;
        ...
        b = E[e];
        for (D = e; D < d; D++)
            (u[D] = u[D + 1]), (v[u[D]] = D), (E[D] = E[D + 1]), (H[E[D]] = D);
        u[d] = F;
        v[F] = d;
        E[d] = b;
        H[b] = d;
        ...
        f = h[F];
        for (D = f + l[F] - 1; f <= D; f++)
            e < Math.abs(J[f]) && (e = Math.abs(J[f]));
        b = E[d];
        Y = q[b];
        for (Z = Y + r[b] - 1; Y <= Z; Y++)
            e < Math.abs(J[Y]) && (e = Math.abs(J[Y]));
    ...
    function ic(a) {
        function b(a, b, c, d, h, l) {
            var n,
                ...
                S = 0;
            (0 < a && 0 < b) ||
            x("triang: m = " + a + "; n = " + b + "; invalid dimension");
            ...
            if (0 == d || 0 == g) Hb(a);
                ...
                for (l = 1; l <= d + g; l++)
                    ...
                    ((n = function (a, b, c) {
                        ...
                        l <= d ? bf(a, l, n) : $e(a, l - d, n));
                for (l = 1; l <= d + g; l++)
                    l <= d ? Fb(a, l, p[l] - df + A) : Gb(a, l - d, p[l] - df + A);
            }
        }
        ...
        if (d != e) {
            ...
            for (d = e; null != d; d = d.na) {
                ...
                for (f = d.Qa; null != f; f = f.next)
                    f.k <= k
                        ? Ua(c, f.k, f.type, f.c, f.f)
                        : Va(c, f.k - k, f.type, f.c, f.f);
                for (f = d.zc; null != f; f = f.next)
                    f.k <= k ? Fb(c, f.k, f.stat) : Gb(c, f.k - k, f.stat);
                if (null != d.fc) {
                    var h,
                        l,
                        k = new Int32Array(1 + e);
    ...
    function of(a) {
        ...
        if (null == e.V)
            ...
            for (f = 1; f <= l + d; f++) {
                ...
                if (n != m || q != p || r != u)
                    (n = {}),
                        ...
                        (e.Qa = n);
                g != k &&
                ((g = {}), (g.k = f), (g.stat = k), (g.next = e.zc), (e.zc = g));
            }
            if (l < c)
                for (
                    m = new Int32Array(1 + d), p = new Float64Array(1 + d), g = c;
                    g > l;
                    g--
                ) {
                    k = b.o[g];
                    ...
                    n = vb(b, g, m, p);
                    for (f = 1; f <= n; f++)
                        (q = {}), (q.H = m[f]), (q.j = p[f]), (q.next = u.l), (u.l = q);
                    u.qa = k.qa;
                    u.stat = k.stat;
                    u.next = e.fc;
                    e.fc = u;
            ...
            c = b.h;
            for (g = 1; g <= c; g++)
                Ua(b, g, a.qe[g], a.oe[g], a.re[g]), Fb(b, g, a.pe[g]);
            for (h = 1; h <= d; h++)
                Va(b, h, a.qe[c + h], a.oe[c + h], a.re[c + h]), Gb(b, h, a.pe[c + h]);
        }
        a.R = null;
    }
    function pf(a, b, c) {
            ...
            if (
                ...
                d.dir == za
                    ? 0 > f
                        ? (m = +t)
                        : (q = +t)
                    : d.dir == Ea && (0 > f ? (m = -t) : (q = -t));
            else {
                for (k = 1; k <= b && l[k] != g; k++);
                k = n[k];
                g <= e
                    ? ((h = d.o[g].stat), (g = d.o[g].M))
                    : ((h = d.g[g - e].stat), (g = d.g[g - e].M));
                if (d.dir == za) {
                    if ((h == M && 0 > g) || (h == P && 0 < g) || h == Ra) g = 0;
                } else
                    d.dir == Ea &&
                    ((h == M && 0 < g) || (h == P && 0 > g) || h == Ra) &&
                    (g = 0);
    ...
    function sf(a, b) {
        ...
        c.dir == za
            ? b != +t &&
            ((c = (b - h) / e),
            c >= Math.floor(c) + 0.001 && ((c = Math.ceil(c)), (b = e * c + h)))
            : c.dir == Ea &&
            b != -t &&
            ((c = (b - h) / e),
            c <= Math.ceil(c) - 0.001 && ((c = Math.floor(c)), (b = e * c + h)));
        return b;
    }
    function tf(a, b) {
        var c = a.F,
    ...
    function xf(a, b) {
        ...
        function g(a, b, c, d, f, g, k, h, l) {
            ...
            k &&
            (q != -t &&
            (q = 0.001 > q - Math.floor(q) ? Math.floor(q) : Math.ceil(q)),
            r != +t &&
        ...
        function k(a, b, c, d, e) {
            ...
            (a || b == -t
                ? g++
                : ((f = c == +t ? 1 + Math.abs(b) : 1 + (c - b)),
                d - b >= 0.25 * f && g++));
            c > e &&
            (a || c == +t
                ? g++
                : ((f = b == -t ? 1 + Math.abs(c) : 1 + (c - b)),
                c - e >= 0.25 * f && g++));
            return g;
        }
        var h = a.F,
            ...
            (function (a, b, d, e, h, l, m, p) {
                ...
                for (; 0 < H; )
                    if (((n = E[H--]), (L[n] = 0), K[n]++, b[n] != -t || d[n] != +t)) {
                        ...
                        if (0 == n)
                            for (m = 1; m <= q; m++)
                                (ea = a.g[m]), 0 != ea.B && (l++, (w[l] = m), (aa[l] = ea.B));
                        else
                            for (m = a.o[n].l; null != m; m = m.G)
                                l++, (w[l] = m.g.H), (aa[l] = m.j);
        ...
        function e(a) {
            ...
            for (c = 1; c <= b.n; c++)
                (d = b.g[c]),
                    d.kind == Ma
                        ? (d.Va = d.w)
                        : d.kind == Fc && (d.Va = Math.floor(d.w + 0.5));
            a.lh++;
        }
        function f(a, b, c) {
            var d = a.F,
            ...
            m = !tf(a, L);
            if (l && m)
                return a.u.s >= mc && y("Both down- and up-branches are hopeless"), 2;
            if (m)
                return (
                    a.u.s >= mc && y("Up-branch is hopeless"),
                        ...
                        (a.R.rc = w),
                        d.dir == za
                            ? a.R.bound < g && (a.R.bound = g)
                            : d.dir == Ea && a.R.bound > g && (a.R.bound = g),
                        1
                );
            if (l)
                return (
                    a.u.s >= mc && y("Down-branch is hopeless"),
                        ...
                        (a.R.rc = v),
                        d.dir == za
                            ? a.R.bound < L && (a.R.bound = L)
                            : d.dir == Ea && a.R.bound > L && (a.R.bound = L),
                        1
                );
            a.u.s >= mc &&
            y("Branching on column " + b + ", primal value is " + e + "");
            l = a.R.p;
            a.R.Sc = b;
            a.R.pg = e;
            of(a);
                    ...
                    switch (((g = h.c), (k = h.f), (d = h.stat), (h = h.M), b.dir)) {
                        case za:
                            d == M
                                ...
                                : d == P &&
                                (0 < h && (h = 0), f - h >= b.xa && (Va(b, c, C, k, k), e++));
                            break;
                        case Ea:
                            d == M
                                ? (0 < h && (h = 0), f + h <= b.xa && (Va(b, c, C, g, g), e++))
        ...
        function l(a) {
            if (a.u.Bd == bb || a.u.yd == bb || a.u.vd == bb || a.u.td == bb) {
                ...
                if (!(d >= c)) {
                        ...
                        for (e = 1; e <= c; e++)
                            for (k = 1; 2 >= k; k++) {
                                ...
                                if (0 != g) {
                                    ...
                                    aa = 0;
                                    0 > p &&
                                    x("lpx_eval_row: len = " + p + "; invalid row length");
                                    for (L = 1; L <= p; L++)
                                        (u = n[L]),
                                        (1 <= u && u <= r) ||
                                        x(
                    ...
                    a.u.td == bb &&
                    null != a.Le &&
                    ((0 == a.R.level && 50 > a.R.Qd) ||
                        (0 < a.R.level && 5 > a.R.Qd)) &&
                    ((c = a.Le),
                        (d = lb(a.F)),
        ...
        for (q = 0; ; ) {
            ...
            switch (q) {
                case 0:
                    ...
                    if (
                        null != a.u.rb &&
                        ((a.reason = Of), a.u.rb(a, a.u.Tc), (a.reason = 0), a.stop)
                    ) {
                        p = Rc;
                        r = 3;
                        break;
                    ...
                    a.u.Bd == bb &&
                    (a.u.s >= Xb && y("MIR cuts enabled"), (a.Tf = Qf(a))),
                    a.u.vd == bb && a.u.s >= Xb && y("Cover cuts enabled"),
                    a.u.td == bb &&
                    (a.u.s >= Xb && y("Clique cuts enabled"), (a.Le = Rf(a.F))));
                case 1:
                    (a.u.s >= mc || (a.u.s >= fc && a.u.dc - 1 <= 1e3 * ma(a.Hg))) &&
                    b(a, 0);
                    a.u.s >= Xb &&
                    60 <= ma(v) &&
                    (y("Time used: " + ma(a.ic) + " secs"), (v = la()));
                    if (0 < a.u.ae && vf(a) <= a.u.ae) {
                        a.u.s >= mc &&
                        y("Relative gap tolerance reached; search terminated ");
                        p = Pc;
                        r = 3;
                        break;
                    }
                    ...
                    if (
                        null != a.u.rb &&
                        ((a.reason = Sf), a.u.rb(a, a.u.Tc), (a.reason = 0), a.stop)
                    ) {
                        p = Rc;
                        r = 3;
                        break;
                    ...
                    r = a.F.wa;
                    if (q == ec && r == ec)
                        a.u.s >= mc && y("Found optimal solution to LP relaxation");
                    else if (r == jc) {
                        a.u.s >= Mb &&
                        y(
                    ...
                    if (0 == a.R.wg) {
                        ...
                        if (
                            null != a.u.rb &&
                            ((a.reason = Vf), a.u.rb(a, a.u.Tc), (a.reason = 0), a.stop)
                        ) {
                            p = Rc;
                            r = 3;
                            break;
                    ...
                    if (null != a.u.rb) {
                        ...
                        if (!c(a, m)) {
                            a.u.s >= mc &&
                            y("Current branch became hopeless and can be pruned");
                            r = 2;
                            break;
                        }
                    }
                    ...
                    if (
                        null != a.u.rb &&
                        ((a.reason = Ia), a.u.rb(a, a.u.Tc), (a.reason = 0), a.stop)
                    ) {
                        p = Rc;
                        r = 3;
                        break;
                    ...
                    if (
                        null != a.u.rb &&
                        ((a.reason = $f), a.u.rb(a, a.u.Tc), (a.reason = 0), a.stop)
                    ) {
                        p = Rc;
                        r = 3;
                        break;
    ...
    function cg(a, b, c) {
        ...
        0 == c
            ...
            ((a.Na[b] = 0),
            d < a.O &&
            ((a.Na[a.ca[a.O]] = d), (a.ca[d] = a.ca[a.O]), (a.j[d] = a.j[a.O])),
                a.O--)
    ...
    function Ff(a) {
        ...
        function c(a, c, d) {
            ...
            for (d = 1; d <= f; d++)
                if (!(1e-10 > Math.abs(c[d])))
                    for (R = e.o[d], S = R.l; null != S; S = S.G)
                        c[f + S.g.H] += c[d] * S.j;
            B = 0;
            for (d = 1; d <= g; d++)
            ...
            for (l = 1; l <= B; l++)
                if (0.001 > Math.abs(h[l]) || 1e3 < Math.abs(h[l])) return;
            Id(a, Bf, B, k, h, Sa, ba);
        }
        var d = a.F,
            e = d.h,
        ...
        for (k = 1; k <= f; k++) {
            ...
            l.stat == A &&
            ((l = b(l.w)),
            0.05 <= l && 0.95 >= l && (e++, (g[e].H = k), (g[e].Pb = l)));
        }
        na(g, e, function (a, b) {
                ...
                if ((0 == b.c[l] && b.f[l] == +t) || (b.c[l] == -t && 0 == b.f[l]))
                    if (
                        ...
                        (0 == b.f[l] && ((q = -q), (r = -r)),
                            0 < q
                                ? 0 == b.ac[n] &&
                                ((b.c[n] = -r / q), (b.ac[n] = m), (b.Gb[l] = 1))
                                : 0 == b.Bb[n] &&
                                ((b.f[n] = -r / q), (b.Bb[n] = m), (b.Gb[l] = 1)));
                    }
        })(a, d);
        (function (a, b) {
            var c = a.F,
    ...
    function Gf(a, b) {
        function c(a, b, c, d, e, f, g) {
                ...
                if (
                    ((h = 1e-9 * (1 + Math.abs(d[l]))),
                        !(
                            e[l] < h ||
                            e[l] > d[l] - h ||
                            ((h = k(a, b, c, d, B, Math.abs(b[l]), g)), h)
                        ))
                ) {
                    u = -q - r * f;
            ...
            for (l = 1; l <= a; l++)
                ...
                e[l] < h ||
                e[l] > d[l] - h ||
                (m++, (H[m].H = l), (H[m].tf = Math.abs(e[l] - 0.5 * d[l])));
            na(H, m, function (a, b) {
        ...
        function e(a) {
            ...
            for (b = 1; b <= a.ab.O; b++)
                ...
                0 == a.Bb[c] &&
                a.c[c] == a.f[c] &&
                ((a.zf -= a.ab.j[b] * a.c[c]), (a.ab.j[b] = 0));
                ...
                (a.ob[d] == jg
                    ? ((e = a.ac[d]),
                        0 == e
                            ...
                            : ((c = a.sa.Na[e]),
                            0 == c &&
                            (cg(a.sa, e, 1), (c = a.sa.Na[e]), (a.sa.j[c] = 0)),
        ...
        function k(a) {
            ...
            for (e = 1; e <= a.J.O; e++)
                (f = a.J.ca[e]), !a.fb[f] && 0 < a.J.j[e] && (a.J.j[e] = 0);
            eg(a.J, 0);
            h = 0;
            for (e = 1; e <= a.J.O; e++)
                (f = a.J.ca[e]),
            ...
            for (e = h + 1; e <= a.J.O; e++)
                (f = a.J.ca[e]),
                    a.ob[f] == jg
                        ...
                        : a.ob[f] == kg &&
                        ((g = a.Bb[f]),
                            (g = 0 == g ? a.f[f] - a.x[f] : a.f[f] * a.x[g] - a.x[f])),
                0 > g && (g = 0),
                    (k -= a.J.j[e] * g);
        ...
        function h(a) {
            ...
            for (b = 1; b <= a.J.O; b++)
                ...
                (a.ob[d] == jg
                    ? (a.Nb += a.J.j[b] * a.c[d])
                    : a.ob[d] == kg &&
                    ((a.Nb -= a.J.j[b] * a.f[d]), (a.J.j[b] = -a.J.j[b])));
            for (b = 1; b <= a.J.O; b++)
                (d = a.J.ca[b]),
                a.fb[d] ||
                (a.ob[d] == jg
        ...
        function n(a, b) {
            ...
            f = 0;
            for (d = b.J.O; 1 <= d; d--)
                (e = b.J.ca[d]), f++, (g[f] = e - c), (h[f] = b.J.j[d]);
                    ...
                    for (O = g(a, H, E, G), S = k(a, H, E, G), u = 1; u <= H; u++)
                        if (f(a, E[u]))
                            for (v = u + 1; v <= H; v++)
                                ...
                                0 == B[p] && (q++, (B[p] = q), (J[q] = p)));
        if (0 == q || 4e3 < q)
            return y("The conflict graph is either empty or too big"), l;
        l = {};
        l.n = m;
        l.Eb = q;
        l.zg = 0;
    ...
    function Nf(a, b, c, d) {
        ...
        n = (function (a, b, c, d) {
            ...
            c = la();
            for (a = 0; a < f.n; a++)
                for (h = n[a] = 0; h < f.n; h++) e(f, a, h) && (n[a] += f.Ic[h + 1]);
    ...
    function mg(a, b) {
        ...
        for (c = 1; c <= a.n; c++)
            ...
            ((f = Dc(a.F, c)),
                (k = Math.floor(f) + 0.5),
            g > Math.abs(f - k) &&
            ((d = c), (g = Math.abs(f - k)), (e = f < k ? zf : Af)));
        b(e);
        return d;
    }
    function og(a) {
        ...
        for (l = 0; ; ) {
            ...
            switch (l) {
                case 0:
                    ...
                    l = 0;
                    for (h = 1; h <= c; h++)
                        (g = b.g[h]), g.kind == Fc && g.type == Q && (e[++l].H = h);
                    d = Ba();
                case 1:
                    hb(d, b, cb);
                    if (b.Da == ec) {
                        ...
                        n = 0.1 * b.ea + 0.9 * b.xa;
                        b.dir == za
                            ? Ua(d, d.h, Ta, 0, n - b.la)
                            : b.dir == Ea && Ua(d, d.h, Sa, n - b.la, 0);
                    }
                    m = 0;
                    for (l = 1; l <= q; l++) e[l].x = -1;
                case 2:
                    if (
                        (m++, a.u.s >= Xb && y("Pass " + m + ""), (r = t), (n = 0), 1 < m)
                    ) {
                        null == f && (f = qg());
                        for (l = 1; l <= q; l++)
                            (h = e[l].H),
                ...
                case 3:
                    ...
                    if (k) {
                        for (l = 1; l <= q; l++)
                            (g = d.g[e[l].H]), (e[l].d = Math.abs(g.w - e[l].x));
                        na(e, q, function (a, b) {
                            return a.d > b.d ? -1 : a.d < b.d ? 1 : 0;
                        });
                        for (l = 1; l <= q && !((5 <= l && 0.35 > e[l].d) || 10 <= l); l++)
                            e[l].x = 1 - e[l].x;
                    }
                case 4:
                    if (2147483647 > a.u.ub && a.u.ub - 1 <= 1e3 * ma(a.ic)) {
                    ...
                    for (l = 1; l <= q; l++)
                        (h = e[l].H),
                            0 == e[l].x ? (d.g[h].B = 1) : ((d.g[h].B = -1), (d.la += 1));
                    k = new kc();
                    a.u.s <= Mb
                        ? (k.s = a.u.s)
                        : a.u.s <= Xb && ((k.s = fc), (k.cb = 1e4));
                    l = sc(d, k);
                    if (0 != l) {
                    ...
                    if (l > q) {
                        ...
                        for (h = 1; h <= c; h++)
                            (g[h] = d.g[h].w),
                            b.g[h].kind == Fc && (g[h] = Math.floor(g[h] + 0.5));
                        d.la = b.la;
                        d.dir = b.dir;
                        for (l = 1; l <= q; l++)
                            (d.g[e[l].H].c = g[e[l].H]),
    ...
    function Yf(a) {
        function b(a, b, c) {
            ...
            for (d = b.l; null != d; d = d.next)
                (e += c[d.H] * d.j), (g += d.j * d.j);
        ...
        for (g = 1; g <= c.size; g++) {
            ...
            d = f[g].Pe;
            k = h = 0;
            for (e = d.l; null != e; e = e.next)
                h++, (l[h] = e.H), (n[h] = e.j), (k += e.j * e.j);
    ...
    function Xe(a, b, c) {
        ...
        0 == n[b]
            ? (a.kd = m[b])
            : ((c = n[b]), c <= d ? (g[c] += r) : (k[c - d] += r), (m[n[b]] = m[b]));
    ...
    function Ye(a, b, c) {
        ...
        0 == n[b]
            ? (a.kd = m[b])
            : ((c = n[b]), c <= d ? (e[c] += r) : (k[c - d] += r), (m[n[b]] = m[b]));
        0 == m[b] ? (a.Vb = n[b]) : (n[m[b]] = n[b]);
        n[b] = a.Vb;
        m[b] = 0;
        0 == n[b] ? (a.kd = b) : (m[n[b]] = b);
        ...
        for (F = 1; F <= d; F++) {
            ...
            for (L = 1; L <= D; L++)
                (z = aa[L]),
                    (K = N[L]),
                (1 <= z && z <= d) ||
                x("luf_factorize: i = " + z + "; j = " + F + "; invalid row index"),
                Y[z] &&
                x(
                    "luf_factorize: i = " +
                    z +
            ...
            for (Z = r[R]; 0 != Z; Z = z) {
                ...
                for (ba = T; ba <= Y; ba++)
                    if (((T = h[ba]), (O = e[T]), (S = O + f[T] - 1), !(f[T] >= w))) {
                        ...
                        if (0 > L) {
                            for (G = O; G <= S; G++)
                                (K = l[G]), 0 > K && (K = -K), L < K && (L = K);
                            n[T] = L;
                        }
                        for (G = e[T]; h[G] != Z; G++);
                        K = l[G];
                        0 > K && (K = -K);
                        if (!(K < v * L) && ((F = T), (D = Z), (w = f[T]), w <= R))
                            return (B = F), (J = D), c();
                    }
                if (0 != F) {
                    if (
    ...
    function Xg(a) {
        ...
        for (l = 1; l <= b; l++)
            for (n = e[l], m = n + f[l] - 1; n <= m; n++)
                (h = g[n]), (a = --c[h]), (g[a] = l), (k[a] = k[n]);
        return 0;
    }
    function xe(a, b, c, d) {
        function e() {
            0 < a.Ya &&
            ((a.Ka = a.Ya),
                (a.yb = new Int32Array(1 + a.Ka)),
                (a.zb = new Float64Array(1 + a.Ka)),
                (a.Ya = 0));
        ...
        if (b)
            for (a = 1; a <= d; a++) {
                if (((p = l[a]), (u = n[a]), (b = r[u]), 0 != b))
                    for (c[p] = b /= g[p], v = e[p], p = v + f[p] - 1; v <= p; v++)
                        r[m[v]] -= q[v] * b;
            }
        else
            for (a = d; 1 <= a; a--)
                if (((p = l[a]), (u = n[a]), (b = r[p]), 0 != b))
                    for (c[u] = b /= g[p], v = k[u], p = v + h[u] - 1; v <= p; v++)
                        r[m[v]] -= q[v] * b;
    }
    var Wd = 401,
        Xd = 402,
    ...
    function Zg(a) {
        ...
        for (var c = 0; c < b.length; c++)
            (a.context[a.mc++] = b[c]), 60 == a.mc && (a.mc = 0);
    }
    function $g(a) {
        var b;
        -1 != a.m &&
        ...
        0 > b && (b = -1),
            ...
            -1 == b
                ...
                (0 <= " \t\n\v\f\r".indexOf(b)
                    ? (b = " ")
                    : ta(b) &&
                    (Zg(a), U(a, "control character " + b + " not allowed"))),
            (a.m = b));
    }
    function ch(a) {
        a.i += a.m;
    ...
    function V(a) {
        ...
        function c() {
            ...
            U(
                a,
                "cannot convert numeric literal " + a.i + " to floating-point number",
            );
        }
        function d() {
            if ("e" == a.m || "E" == a.m)
                for (
                    ...
                    ch(a);
            if (ua(a.m) || "_" == a.m)
                Zg(a), U(a, "symbol " + a.i + a.m + "... should be enclosed in quotes");
        }
        a.Df = a.b;
        a.Cf = a.Db;
        a.Bf = a.i;
        a.Ef = a.value;
        if (a.Se)
            (a.Se = 0), (a.b = a.If), (a.Db = a.Hf), (a.i = a.Gf), (a.value = a.Jf);
        else {
            for (;;) {
                a.b = 0;
                a.Db = 0;
                    ...
                    if (!a.oc && wa(a.m)) {
                        ...
                        if (a.oc || "-" != a.m)
                            if ("*" == a.m)
                                ...
                                (a.b = 218), ch(a), "=" == a.m && ((a.b = 235), ch(a));
                            else if ("&" == a.m)
                                (a.b = 236), ch(a), "&" == a.m && ((a.b = 206), ch(a));
                            else if ("|" == a.m)
                                (a.b = 237), ch(a), "|" == a.m && ((a.b = 219), ch(a));
                            else if (a.oc || "." != a.m)
                                if ("," == a.m) (a.b = 239), ch(a);
                                else if (":" == a.m)
                                    (a.b = 240), ch(a), "=" == a.m && ((a.b = 242), ch(a));
                            ...
                            else if (((a.b = 238), ch(a), a.Re))
                                (a.b = 243), (a.Db = 2), (a.i = ".."), (a.Re = 0);
            ...
            if (202 == a.b)
                if (
                    ...
                    for (f = 1; f < g; f++)
                        null != d[f].name &&
                        d[f].name == a.i &&
                        U(a, "duplicate dummy index " + a.i + " not allowed");
                    d[g].name = a.i;
                    d[g].code = null;
                    V(a);
                    k = 1;
    ...
    function sh(a) {
        ...
        for (b = {}; ; ) {
            ...
            202 == a.b
                ...
                213 == d &&
                null == a.$[a.i] &&
                ((c = {}), (d = a.i), ph(c, d, null), V(a), V(a)))
                : 244 == a.b &&
                ((a.Lf = 1),
                    (e = th(a)),
                311 == e.Wa && ((c = e.a.slice), (e = null), V(a)));
            null == e && (e = th(a));
            if (106 != e.type) {
            ...
            for (d = c.list; null != d; d = d.next)
                null != d.name && (a.$[d.name] = { type: 111, link: d });
            if (239 == a.b) V(a);
    ...
    function Dh(a) {
        var b, c;
        if (204 == a.b)
            (b = Yg()), (b.U = a.value), (b = gh(301, b, 118, 0)), V(a), (c = b);
        else if (214 == a.b) (b = Yg()), (b.U = t), (c = gh(301, b, 118, 0)), V(a);
        else if (205 == a.b)
            (b = Yg()), (b.P = a.i), (b = gh(302, b, 124, 0)), V(a), (c = b);
        else if (202 == a.b)
                ...
                case 244:
                    ...
                    if (375 == b || 376 == b)
                        ...
                        336 == b
                            ? ((f = th(a)),
                            106 != f.type &&
                            U(a, "argument for " + d + " has invalid type"))
            ...
            if (211 != a.b)
                106 == c.type && U(a, "keyword else missing where expected"),
                    (d = null);
            else {
                V(a);
                d = th(a);
    ...
    function Lh(a) {
        ...
        for (g.link = f; ; ) {
            ...
            if (eh(a, "dimen")) {
                ...
                213 != a.b ||
                a.ng ||
                (ah(a, "keyword in understood as within"), (a.ng = 1));
                V(a);
                ...
                f.v + f.aa > h.set.aa
                    ? d()
                    : f.v + f.aa < h.set.aa && U(a, "dimension of " + a.i + " too big");
                V(a);
                ...
                U(
                    a,
                    "there are must be " + h.set.aa + " components rather than " + g,
                );
                V(a);
    ...
    function Mh(a) {
        ...
        for (e.link = d; ; ) {
            ...
            if (eh(a, "integer"))
            ...
            else if (eh(a, "logical"))
                a.Ie || (ah(a, "keyword logical understood as binary"), (a.Ie = 1)),
                    b();
            else if (eh(a, "symbolic"))
                k && U(a, "at most one symbolic allowed"),
                118 != d.type &&
                U(a, "integer or binary parameter cannot be symbolic"),
                ...
                118 != l.code.type &&
                124 != l.code.type &&
                U(a, "expression following " + h + " has invalid type");
                124 != d.type &&
                124 == l.code.type &&
                (l.code = W(316, l.code, 118, 0));
                124 == d.type &&
                124 != l.code.type &&
                (l.code = W(317, l.code, 124, 0));
            } else if (213 == a.b || 224 == a.b) {
                224 != a.b ||
                a.mg ||
                (ah(a, "keyword within understood as in"), (a.mg = 1));
                V(a);
                l = { code: null, next: null };
                if (null == d.ua) d.ua = l;
                else {
                ...
                242 == a.b
                    ...
                    124 != d.type &&
                    124 == d.assign.type &&
                    (d.assign = W(316, d.assign, 118, 0)),
                    124 == d.type &&
                    124 != d.assign.type &&
                    (d.assign = W(317, d.assign, 124, 0)))
                    : eh(a, "default")
                        ? ((null == d.assign && null == d.Ba) || c(),
                            V(a),
                            (d.Ba = mh(a)),
                        ...
                        124 != d.type &&
                        124 == d.Ba.type &&
                        (d.Ba = W(316, d.Ba, 118, 0)),
                        124 == d.type &&
                        124 != d.Ba.type &&
                        (d.Ba = W(317, d.Ba, 124, 0)))
    ...
    function Ph(a) {
        ...
        201 != a.b &&
        ah(a, "some text detected beyond end statement; text ignored");
    }
    function Rh(a, b) {
        var c = { C: {} };
        c.gb = a.gb;
        ...
        if (eh(a, "set"))
            ...
            248 == a.b
                ? ((e.type = 119),
                    (e.C.Nc.domain = sh(a)),
                eh(a, "OUT") || U(a, "keyword OUT missing where expected"))
                : ((e.type = 112),
                eh(a, "IN") || U(a, "keyword IN missing where expected"));
            V(a);
            for (e.a = f = null; ; )
                if (
                    ((k = {}),
                    (239 != a.b && 240 != a.b && 241 != a.b) ||
            ...
            switch (e.type) {
                case 112:
                    ...
                    f = 0;
                    for (
                        246 == a.b ? V(a) : U(a, "field list missing where expected");
                        ;
            ...
            for (240 == a.b && V(a); ; ) {
                ...
                e = f;
                if (202 == a.b)
                    if ((V(a), (k = a.b), dh(a), 239 != k && 241 != k))
                        (f.type = 108), (f.C.code = rh(a));
                    else {
                        k = a.$[a.i];
            ...
            for (
                124 != f.xd.type && U(a, "format expression has invalid type");
                239 == a.b;
            ...
            if (248 != a.b) f.list = Rh(a, 1);
                ...
                for (V(a); 249 != a.b; )
                    (e = Rh(a, 1)), null == g ? (f.list = e) : (g.next = e), (g = e);
                V(a);
            }
            uh(a, f.domain);
            d.Pg = f;
            ...
            null == c.ba
                ...
                ((e = Vh(c)),
                    1 == e
                        ...
                        : U(
                            a,
                            e + " items missing in data group beginning with " + di(f),
                        )),
                    (e = Yh(a)),
                null == f && (f = e))
                : (e = ei(c.ba)),
    ...
    function hi(a, b, c, d) {
        var e, f, g, k, h;
        for (e = null; 242 != a.b; )
            Xh(a) || U(a, "number, symbol, or := missing where expected"),
                (e = Th(e, Yh(a)));
        for (V(a); Xh(a); )
                    ...
                    if (Qh(a, "-")) {
                        ...
                        (g = Uh(f)),
                            1 == g
                                ...
                                : U(
                                    a,
                                    g + " items missing in data group beginning with " + di(h),
                                );
                k = null;
    ...
    function ii(a) {
        ...
        if (246 == a.b) {
            ...
            for (V(a); ; )
                if (
                    (Xh(a) || U(a, "number or symbol missing where expected"),
                        (f = fi(f, Yh(a))),
                    239 == a.b)
                )
                    V(a);
        ...
        for (k = Wh(e.aa); ; )
            if ((239 == a.b && V(a), 242 == a.b)) V(a);
                ...
                V(a),
                    ...
                    f
                        ? d()
                        : ((k = ai(a, e.name, e.aa)), (h = 0), 0 == Vh(k) && ci(a, g, k));
                ...
                Qh(a, ".")
                    ...
                    ((d = Uh(f)),
                        1 == d
                            ? U(
                                a,
                                "one item missing in data group beginning with " + di(g.ba),
                            )
                            : U(
                                a,
                                d +
        ...
        if (240 == a.b)
            ...
            for (
                ...
                if ((239 == a.b && V(a), 242 == a.b)) V(a);
                    ...
                    0 == e.v && b(), 2 != Vh(g) && c(), V(a), si(a, e, g, k);
                else if (244 == a.b)
                    V(a),
                    Qh(a, "tr") || d(),
                    0 == e.v && b(),
    ...
    function Ei(a, b, c) {
        ...
        0 == b
            ...
            : (((1 < Math.abs(b) &&
                    1 < c &&
                    +Math.log(Math.abs(b)) > (0.999 * Math.log(t)) / c) ||
                (1 > Math.abs(b) &&
                    -1 > c &&
                    +Math.log(Math.abs(b)) < (0.999 * Math.log(t)) / c)) &&
            U(a, b + " ** " + c + "; floating-point overflow"),
    ...
    function Ri(a) {
        var b, c;
        do
            (b = -1 + 2 * (Qi(a.Fd) / 2147483648)),
                (c = -1 + 2 * (Qi(a.Fd) / 2147483648)),
                (b = b * b + c * c);
        while (1 < b || 0 == b);
    ...
    function ui(a) {
        ...
        if (null == a) b = null;
            ...
            for (b = c = {}; null != a; a = a.next)
                (c.ba = ei(a.ba)), null != a.next && (c = c.next = {});
            c.next = null;
        }
        return b;
    }
    ...
    function Vi(a, b) {
        for (var c = null, d = 1, e = a; d <= b; d++, e = e.next)
            c = fi(c, ei(e.ba));
        return c;
    }
    function li(a, b) {
    ...
    function aj(a) {
        ...
        if (null == a) b = null;
            ...
            for (b = c = {}; null != a; a = a.next)
                (c.B = a.B), (c.A = a.A), null != a.next && (c = c.next = {});
            c.next = null;
        }
        return b;
    }
    function bj(a, b, c, d, e) {
        ...
        for (g = c; null != g; g = g.next)
            null == g.A
                ? (k = xi(a, k, Ai(a, b, g.B)))
                : (g.A.na = xi(a, g.A.na, Ai(a, b, g.B)));
        for (g = e; null != g; g = g.next)
            null == g.A
                ? (k = xi(a, k, Ai(a, d, g.B)))
                : (g.A.na = xi(a, g.A.na, Ai(a, d, g.B)));
        for (g = c; null != g; g = g.next)
            null != g.A &&
            0 != g.A.na &&
            ((a = {}),
    ...
    function cj(a, b, c) {
        for (var d = null, e, f = 0; null != b; )
            (e = b),
                (b = b.next),
                null == e.A ? (f = xi(a, f, e.B)) : ((e.next = d), (d = e));
        c(f);
        return d;
    }
    function dj(a, b) {
            ...
            for (b = a.list, a = a.Je; null != b; b = b.next, a = a.next)
                a: {
                    ...
                    for (e = c.list; null != e; e = e.a.index.next)
                        for (f = e; null != f; f = f.V)
                            f.valid && ((f.valid = 0), dj(f.type, f.value));
                    c.value = ei(d);
                }
    }
    ...
    function ij(a, b) {
        if (null != b.block) {
            ...
            for (d = c.list; null != d; d = d.next)
                null == e ? (e = f = {}) : (f = f.next = {}),
                    null == d.code
                        ? ((f.ba = b.D.ba), (b.D = b.D.next))
                        : (f.ba = jj(a, d.code));
            f.next = null;
            gj(a, c, e, b, ij) && (b.Te = 1);
            for (d = c.list; null != d; d = d.next) e = e.next;
        } else
            null == b.domain.code || kj(a, b.domain.code)
                ? b.Xd(a, b.info)
                : (b.Te = 2);
    }
    ...
    function mj(a, b) {
        if (null != b.block) {
            ...
            e = null;
            for (d = c.list; null != d; d = d.next)
                null != d.code && (e = fi(e, jj(a, d.code)));
            if (372 == c.code.Wa) {
                var f, g, k, h;
                g = X(a, c.code.a.a.x);
                k = X(a, c.code.a.a.y);
                ...
                d = fi(null, Zh(0));
                for (f = 1; f <= e && b.Sf; f++)
                    (d.ba.U = Zi(a, g, k, h, f)), gj(a, c, d, b, mj);
            } else
            ...
            b.block = c;
        } else if (null == b.domain.code || kj(a, b.domain.code))
            b.Sf = !b.Xd(a, b.info);
    }
    function oj(a, b, c, d) {
        var e = {};
    ...
    function qj(a) {
        ...
        if (null != a)
            for (a = a.list; null != a; a = a.next)
                for (var c = a.list; null != c; c = c.next)
                    null == c.code && (b = fi(b, ei(c.value)));
        return b;
    }
    function rj(a, b, c, d) {
    ...
    function tj(a, b) {
        null != b.ka
            ? rj(a, b.set, b.ka.D, b.ka.value.set)
            : (b.me = sj(a, b.set, b.D));
    }
    function uj(a, b) {
        var c = b.Xc,
    ...
    function wj(a, b, c) {
        ...
        if (1 == b.data)
            for (
                ...
                null != d.ka &&
                (lj(a, b.domain, d.ka.D, d, tj) && pj(a, b.name, d.ka.D), d.ka != c);
                d.ka = d.ka.next
            );
        d.ka = null;
    ...
    function xj(a, b, c, d) {
        ...
        switch (b.type) {
            case 113:
                d != Math.floor(d) &&
                U(a, b.name + li("[", c) + " = " + d + " not integer");
                break;
            case 101:
                0 != d &&
                1 != d &&
                U(a, b.name + li("[", c) + " = " + d + " not binary");
        }
        e = b.ud;
            ...
            : null != b.assign
                ...
                : null != b.Ba
                    ...
                    : null != b.Vc
                        ...
                        U(
                            a,
                            "cannot convert " + di(b.Vc) + " to floating-point number",
                        ),
                            d(b.Vc.U))
                        : U(a, "no value for " + b.name + li("[", c));
    }
    function zj(a, b) {
        null != b.ka
            ? xj(a, b.W, b.ka.D, b.ka.value.U)
            : (b.value = yj(a, b.W, b.D));
    }
    function Aj(a, b, c) {
        var d = {};
        d.W = b;
        ...
        if (1 == b.data)
            for (
                c = b.T.$a, b.data = 2, d.ka = b.T.head;
                null != d.ka &&
                (lj(a, b.domain, d.ka.D, d, zj) && pj(a, b.name, d.ka.D), d.ka != c);
                d.ka = d.ka.next
            );
        d.ka = null;
    ...
    function Dj(a, b) {
        null != b.ka
            ? Bj(a, b.W, b.ka.D, b.ka.value.ba)
            : (b.value = Cj(a, b.W, b.D));
    }
    function Ej(a, b, c) {
        var d = {};
        d.W = b;
        ...
        if (1 == b.data)
            for (
                c = b.T.$a, b.data = 2, d.ka = b.T.head;
                null != d.ka &&
                (lj(a, b.domain, d.ka.D, d, Dj) && pj(a, b.name, d.ka.D), d.ka != c);
                d.ka = d.ka.next
            );
        d.ka = null;
    ...
    function X(a, b) {
        ...
        switch (b.Wa) {
            ...
            case 375:
                c = +t;
                for (e = b.a.list; null != e; e = e.next)
                    (d = X(a, e.x)), c > d && (c = d);
                break;
            case 376:
                c = -t;
        ...
        switch (b.Wa) {
            ...
            case 374:
                ...
                369 == b.Wa
                    ...
                    U(
                        a,
                        "substr('...', " + e + ", " + k + "); substring out of range",
                    ));
    ...
    function nj(a, b) {
        ...
        switch (b.Wa) {
            ...
            case 360:
                d = nj(a, b.a.a.x);
                for (c = nj(a, b.a.a.y).head; null != c; c = c.next)
                    null == ki(a, d, c.D) && Wi(d, ui(c.D));
                c = d;
                break;
            case 361:
                var e = nj(a, b.a.a.x);
            ...
            case 362:
                ...
                for (e = c.head; null != e; e = e.next)
                    null == ki(a, d, e.D) && Wi(f, ui(e.D));
                c = f;
                break;
            case 363:
                e = nj(a, b.a.a.x);
    ...
    function Vj(a, b) {
        switch (b.code.Wa) {
            case 377:
                ...
                for (
                    null == b.value ? (b.value = c) : (b.$a.next = c);
                    null != c;
                    c = c.next
                )
                    b.$a = c;
    ...
    function fk(a, b) {
        ...
        U(a, "error on writing data to table " + a.lb.C.tab.name);
        return 0;
    }
    function gk(a, b) {
        ...
        0 == d || 4 == d
            ...
            : 1 == d
                ? ik(
                    ...
                    li("[", c.D) +
                    ".lb = " +
                    (null == c.value.A.A.S ? -t : c.value.A.S),
                )
                : 2 == d
                    ? ik(
                        a,
                        ...
                        li("[", c.D) +
                        ".ub = " +
                        (null == c.value.A.A.Z ? +t : c.value.A.Z),
                    )
                    : 3 == d
        ...
        0 == d || 4 == d
            ...
            : 1 == d
                ? ik(
                    ...
                    li("[", c.D) +
                    ".lb = " +
                    (null == c.value.K.K.S ? -t : c.value.K.S),
                )
                : 2 == d
                    ? ik(
                        a,
                        ...
                        li("[", c.D) +
                        ".ub = " +
                        (null == c.value.K.K.Z ? +t : c.value.K.Z),
                    )
                    : 3 == d
    ...
    function mk(a, b) {
        for (var c, d = b.list; null != d; d = d.next)
            if (111 == d.type) (c = d.C.Ca), ik(a, c.name + " = " + di(c.value));
                ...
                null != e.assign
                    ? oj(a, e.domain, e, vj)
                    : (null != e.Xc && 0 == e.data && uj(a, e),
                    null != e.T.head && wj(a, e, e.T.head.D));
                ...
                for (
                    e = d.C.W,
                        null != e.assign
                            ? oj(a, e.domain, e, Fj)
                            : null != e.T.head &&
                            (124 != e.type ? Aj(a, e, e.T.head.D) : Ej(a, e, e.T.head.D)),
                    null == e.T.head && ik(a, e.name + " has empty content"),
                        c = e.T.head;
                    null != c;
                    c = c.next
                ...
                if (
                    ...
                    var f = { value: {} },
                        g = void 0;
                    f.D = null;
                    for (g = e.a.W.list || e.a.A.list; null != g; g = g.next)
                        f.D = fi(f.D, jj(c, g.x));
                    switch (e.Wa) {
                        case 304:
                    ...
                    switch (((c = a), e.type)) {
                        ...
                        case 110:
                            for (
                                f = void 0,
                                    e = Jj(c, e),
                                null == e && ik(c, "linear form is empty"),
                                    f = e;
                                null != f;
                                f = f.next
                            )
                    ...
                    if (
                        ...
                        switch (c.code.type) {
                            ...
                            case 124:
                                k = jj(a, c.code);
                                null != k.P &&
                                U(a, "cannot convert " + di(k) + " to floating-point number");
                                g = k.U;
                                break;
                            case 114:
                                g = kj(a, c.code) ? 1 : 0;
    ...
    function rk(a, b) {
        ...
        switch (b.type) {
                ...
                switch (c.type) {
                    case 112:
                        ...
                        for (e = c.C.ua.list; null != e; e = e.next)
                            e.W.data && U(a, e.W.name + " already provided with data"),
                                (e.W.data = 1);
                        ...
                        for (sk(a, "R"); ; ) {
                            ...
                            0 < d &&
                            U(g, "error on reading data from table " + g.lb.C.tab.name);
                            if (d) break;
                            for (g = 1; g <= f.Za; g++)
                                "?" == f.type[g] &&
                            ...
                            for (e = c.C.ua.list; null != e; e = e.next)
                                switch (
                                    (g++,
                                    null != ki(a, e.W.T, d) &&
                                    U(a, e.W.name + li("[", d) + " already defined"),
                                        (k = mi(e.W.T, ui(d))),
                                        e.W.type)
                                    ) {
                                    case 118:
                                    ...
                                    case 101:
                                        "N" != f.type[g] &&
                                        U(a, e.W.name + " requires numeric data");
                                        k.value.U = f.U[g];
                                        break;
                                    case 124:
                                        switch (f.type[g]) {
            ...
            case 121:
                ...
                null == c.Ia
                    ? (a.je = null)
                    : ((f = jj(a, c.Ia)), (a.je = null == f.P ? f.U : f.P));
                oj(a, c.domain, c, pk);
                break;
            case 109:
    ...
    var Ld = (exports.mpl_initialize = function () {
        ...
        Pd = (exports.mpl_read_data = function (a, b, c) {
            ...
            uk(a, b, c);
            Qh(a, "data") &&
            (V(a), 241 != a.b && U(a, "semicolon missing where expected"), V(a));
            wi(a);
            Ph(a);
            y(a.gb + " line" + (1 == a.gb ? "" : "s") + " were read");
            a.af = null;
            ...
            for (b = a.uc; null != b; b = b.next)
                if (103 == b.type)
                    for (c = b.C.K, c = c.T.head; null != c; c = c.next)
                        for (
                            c.value.K.ia = ++a.h, d = c.value.K.form;
                            null != d;
                            d = d.next
                        )
                            d.A.ka.value.A.H = -1;
            for (b = a.uc; null != b; b = b.next)
                if (127 == b.type)
                    for (c = b.C.A, c = c.T.head; null != c; c = c.next)
                        0 != c.value.A.H && (c.value.A.H = ++a.n);
            a.o = Array(1 + a.h);
            for (d = 1; d <= a.h; d++) a.o[d] = null;
            for (b = a.uc; null != b; b = b.next)
                if (103 == b.type)
                    for (c = b.C.K, c = c.T.head; null != c; c = c.next)
                        (d = c.value.K.ia), (a.o[d] = c.value.K);
            for (d = 1; d <= a.h; d++);
            a.g = Array(1 + a.n);
        ...
        Ud = (exports.mpl_get_row_name = function (a, b) {
            ...
            (1 <= b && b <= a.h) ||
            x("mpl_get_row_name: i = " + b + "; row number out of range");
            var c = a.o[b].K.name,
        ...
        ie = (exports.mpl_get_row_kind = function (a, b) {
            ...
            (1 <= b && b <= a.h) ||
            x("mpl_get_row_kind: i = " + b + "; row number out of range");
            switch (a.o[b].K.type) {
                case 103:
                    c = 411;
                    break;
        ...
        Vd = (exports.mpl_get_row_bnds = function (a, b, c) {
            ...
            (1 <= b && b <= a.h) ||
            x("mpl_get_row_bnds: i = " + b + "; row number out of range");
            d = a.o[b];
            a = null == d.K.S ? -t : d.S;
            b = null == d.K.Z ? +t : d.Z;
            a == -t && b == +t
        ...
        he = (exports.mpl_get_mat_row = function (a, b, c, d) {
            ...
            (1 <= b && b <= a.h) ||
            x("mpl_get_mat_row: i = " + b + "; row number out of range");
            for (a = a.o[b].form; null != a; a = a.next)
                e++, null != c && (c[e] = a.A.H), null != d && (d[e] = a.B);
            return e;
        }),
        ae = (exports.mpl_get_row_c0 = function (a, b) {
            ...
            (1 <= b && b <= a.h) ||
            x("mpl_get_row_c0: i = " + b + "; row number out of range");
            c = a.o[b];
        ...
        ce = (exports.mpl_get_col_name = function (a, b) {
            ...
            (1 <= b && b <= a.n) ||
            x("mpl_get_col_name: j = " + b + "; column number out of range");
            var c = a.g[b].A.name,
                c = c + li("[", a.g[b].ka.D);
            255 == c.length && (c = c.slice(0, 252) + "...");
            return c;
        ...
        de = (exports.mpl_get_col_kind = function (a, b) {
            ...
            (1 <= b && b <= a.n) ||
            x("mpl_get_col_kind: j = " + b + "; column number out of range");
            switch (a.g[b].A.type) {
                case 118:
                    c = 421;
                    break;
        ...
        ge = (exports.mpl_get_col_bnds = function (a, b, c) {
            ...
            (1 <= b && b <= a.n) ||
            x("mpl_get_col_bnds: j = " + b + "; column number out of range");
            d = a.g[b];
            a = null == d.A.S ? -t : d.S;
            b = null == d.A.Z ? +t : d.Z;
            a == -t && b == +t
        ...
        for (u = p = 0; u < c.length; u++)
            if ("%" == c[u])
                if ((u++, "b" == c[u] || "h" == c[u])) {
                    var v;
                    for (
                        0 <= h && Ak(a, b, p, c, u, "month multiply specified");
                        " " == b[p];
                    ...
                    for (h = 1; 12 >= h; h++) {
                        ...
                        if (!H) {
                            ...
                            for (
                                g = 3;
                                "\x00" != v[g] && b[p].toUpperCase() == v[g].toUpperCase();
                                g++
                            )
                                p++;
                            break;
                    ...
                    12 < h &&
                    Ak(a, b, p, c, u, "abbreviated month name missing or invalid");
                } else if ("d" == c[u]) {
                    for (
                        0 <= l && Ak(a, b, p, c, u, "day multiply specified");
                        " " == b[p];

                    )
                        p++;
                    ("0" <= b[p] && "9" >= b[p]) ||
                    Ak(a, b, p, c, u, "day missing or invalid");
                    l = b[p++] - 0;
                    "0" <= b[p] && "9" >= b[p] && (l = 10 * l + (b[p++] - 0));
                    (1 <= l && 31 >= l) || Ak(a, b, p, c, u, "day out of range");
                } else if ("H" == c[u]) {
                    for (
                        0 <= n && Ak(a, b, p, c, u, "hour multiply specified");
                        " " == b[p];

                    )
                        p++;
                    ("0" <= b[p] && "9" >= b[p]) ||
                    Ak(a, b, p, c, u, "hour missing or invalid");
                    n = b[p++] - 0;
                    ...
                    for (
                        ...
                        p++;
                    ("0" <= b[p] && "9" >= b[p]) ||
                    Ak(a, b, p, c, u, "month missing or invalid");
                    h = b[p++] - 0;
                    "0" <= b[p] && "9" >= b[p] && (h = 10 * h + (b[p++] - 0));
                    (1 <= h && 12 >= h) || Ak(a, b, p, c, u, "month out of range");
                } else if ("M" == c[u]) {
                    for (
                        0 <= m && Ak(a, b, p, c, u, "minute multiply specified");
                        " " == b[p];
                    ...
                    for (
                        0 <= q && Ak(a, b, p, c, u, "second multiply specified");
                        " " == b[p];

                    )
                        p++;
                    ("0" <= b[p] && "9" >= b[p]) ||
                    Ak(a, b, p, c, u, "second missing or invalid");
                    q = b[p++] - 0;
                    "0" <= b[p] && "9" >= b[p] && (q = 10 * q + (b[p++] - 0));
                    (0 <= q && 60 >= q) || Ak(a, b, p, c, u, "second out of range");
                } else if ("y" == c[u]) {
                    for (
                        0 <= k && Ak(a, b, p, c, u, "year multiply specified");
                        " " == b[p];
                    ...
                    for (
                        2147483647 != r &&
                        Ak(a, b, p, c, u, "time zone offset multiply specified");
                        " " == b[p];
                    ...
                    "%" == c[u] ? f() : Ak(a, b, p, c, u, "invalid conversion specifier");
            else " " != c[u] && f();
        0 > k && (k = 1970);
        0 > h && (h = 1);
        0 > l && (l = 1);
    ...
    function Gk(a, b, c) {
        ...
        if ("R" == b) {
            c
                ...
                : x("csv_driver: unable to open " + this.Ia);
            this.Ag = 0;
            for (Hk(this); ; ) {
                Hk(this);
                if (this.Jb == this.ye) break;
                this.Jb != this.ze &&
                x(this.Ia + ":" + this.count + ": invalid field name\n");
                this.Za++;
    ...
    function Ik(a) {
        ...
        for ("\n" == a.m && a.count++; ; )
            if (
                (a.cursor < a.data.length ? (b = a.data[a.cursor++]) : (b = -1),
                "\r" != b)
            ) {
                "\n" != b &&
                ta(b) &&
                x(a.Ia + ":" + a.count + ": invalid control character " + b);
                break;
            }
        a.m = b;
    }
    ...
    function Kk(a, b, c) {
        0 == c
            ? ((b.ga = null),
                (b.next = a.Fb),
                null == b.next ? (a.Oc = b) : (b.next.ga = b),
                (a.Fb = b))
            : ((b.ga = a.Oc),
                (b.next = null),
                null == b.ga ? (a.Fb = b) : (b.ga.next = b),
                (a.Oc = b));
    }
    function Lk(a, b) {
    ...
    function Nk(a, b, c) {
        0 == c
            ? ((b.ga = null),
                (b.next = a.Mb),
                null == b.next ? (a.rd = b) : (b.next.ga = b),
                (a.Mb = b))
            : ((b.ga = a.rd),
                (b.next = null),
                null == b.ga ? (a.Mb = b) : (b.ga.next = b),
                (a.rd = b));
    }
    function Ok(a, b) {
    ...
    function Uk(a) {
        for (var b; null != a.l; )
            (b = a.l),
                (a.l = b.G),
                null == b.va ? (b.g.l = b.L) : (b.va.L = b.L),
            null != b.L && (b.L.va = b.va);
    }
    function Vk(a, b) {
        Uk(b);
        Lk(a, b);
    ...
    function Wk(a, b) {
        for (var c; null != b.l; )
            (c = b.l),
                (b.l = c.L),
                null == c.ya ? (c.o.l = c.G) : (c.ya.G = c.G),
            null != c.G && (c.G.ya = c.ya);
        Ok(a, b);
    }
    function Zb(a, b, c) {
        var d = cb,
    ...
    function Vb(a, b) {
        ...
        if (a.ha != Sc)
            for (
                null == a.Ea && (a.Ea = new Float64Array(1 + a.ce)), f = 1;
                f <= a.ce;
                f++
            )
                a.Ea[f] = t;
        if (a.ha == $b) {
            for (f = 1; f <= a.h; f++)
                (c = b.o[f]), (e = a.qf[f]), (a.pa[e] = c.stat), (a.Ea[e] = d * c.M);
            for (c = 1; c <= a.n; c++)
                (d = b.g[c]), (e = a.Rd[c]), (a.oa[e] = d.stat), (a.Sa[e] = d.w);
        } else if (a.ha == le) {
            for (f = 1; f <= a.h; f++)
                (c = b.o[f]), (e = a.qf[f]), (a.Ea[e] = d * c.nc);
    ...
    function Wb(a, b) {
        ...
        if (a.ha == $b) {
            ...
            b.Zd = b.la;
            for (d = 1; d <= b.h; d++)
                (c = b.o[d]), (c.nc = a.se ? e * a.Ea[d] * c.qa : e * a.Ea[d]);
            for (d = 1; d <= b.n; d++)
                (c = b.g[d]),
                    a.se ? (c.Tb = a.Sa[d] * c.za) : (c.Tb = a.Sa[d]),
                    (b.Zd += c.B * c.Tb);
            for (d = 1; d <= b.h; d++) {
                c = b.o[d];
                f = 0;
            ...
            b.xa = b.la;
            for (d = 1; d <= b.n; d++)
                (c = b.g[d]), (c.Va = a.Sa[d]), (b.xa += c.B * c.Va);
            for (d = 1; d <= b.h; d++) {
                c = b.o[d];
                f = 0;
    ...
    function Yk(a, b) {
        ...
        c = Tk(a, function (a, b) {
            if (a.ha == $b)
                if (a.oa[b.q] == A || a.oa[b.q] == M || a.oa[b.q] == P)
                    a.oa[b.q] = a.oa[b.q];
                else return 1;
    ...
    function al(a, b) {
        ...
        if (a.ha == $b)
            for (d = b.l; null != d; d = d.L)
                (e = {}), (e.Ra = d.o.ia), (e.j = d.j), (e.next = c.l), (c.l = e);
        c = 0.5 * (b.f + b.c);
        d = Math.floor(c + 0.5);
        Math.abs(c - d) <= f && (c = d);
        b.c = b.f = c;
    ...
    function dl(aglp_get_col_prim, b) {
        var c;
        if (a.Ua)
    ...
    function el(a, b) {
        ...
        if (a.ha != Sc)
            for (e = d.l; null != e; e = e.L)
                e.o != b &&
                ((d = {}), (d.Ra = e.o.ia), (d.j = e.j), (d.next = c.l), (c.l = d));
        Vk(a, b);
        return 0;
    }
    function fl(a, b) {
        ...
        if (
            a.c != -t &&
            ((c = a.Ua ? 0.001 : 0.001 + 1e-6 * Math.abs(a.c)), b < a.c + c)
        )
            return 0;
        if (a.f != +t) {
            c = a.Ua ? 1e-5 : 1e-5 + 1e-8 * Math.abs(a.f);
    ...
    function gl(a, b) {
        ...
        if (
            a.f != +t &&
            ((c = a.Ua ? 0.001 : 0.001 + 1e-6 * Math.abs(a.f)), b > a.f - c)
        )
            return 0;
        if (a.c != -t) {
            c = a.Ua ? 1e-5 : 1e-5 + 1e-8 * Math.abs(a.c);
    ...
    function hl(a, b) {
        ...
        c = Tk(a, function (a, b) {
            ...
            if (a.ha == $b) {
                ...
                if (a.oa[b.q] == A) (a.pa[b.p] = A), (a.Ea[b.p] = 0);
                    ...
                    if (
                        1e-7 < d &&
                        ((0 < b.Ha && b.c != -t) || (0 > b.Ha && b.f != +t) || !b.Rf)
                    )
                        return (a.oa[b.q] = M), e();
                    if (
                        -1e-7 > d &&
                        ((0 < b.Ha && b.f != +t) || (0 > b.Ha && b.c != -t) || !b.cg)
                    )
                        return (a.oa[b.q] = P), c();
                    if (b.c != -t && b.f == +t) a.pa[b.p] = M;
                    else if (b.c == -t && b.f != +t) a.pa[b.p] = P;
                    else if (b.c != -t && b.f != +t)
                        a.pa[b.p] = b.Ha * a.Sa[b.q] <= 0.5 * (b.c + b.f) ? M : P;
                    else return 1;
                    a.oa[b.q] = A;
                    a.Ea[b.p] = d / b.Ha;
                } else return 1;
            ...
            a.ha == le &&
            (a.Ea[b.p] =
                (2.220446049250313e-16 < d && b.Rf) ||
                (-2.220446049250313e-16 > d && b.cg)
                    ? d / b.Ha
                    : 0);
            return 0;
        });
        ...
        if (a.ha != Sc)
            for (d = d.l; null != d; d = d.L)
                d != e &&
                ((f = {}), (f.Ra = d.o.ia), (f.j = d.j), (f.next = c.l), (c.l = f));
        Vk(a, b);
        return g >= k ? g : k;
    }
    function il(a, b) {
        ...
        a.la += (c.od / c.Ha) * c.m;
        0 < c.Ha
            ? ((d.c = b.f == +t ? -t : c.od - c.Ha * b.f),
                (d.f = b.c == -t ? +t : c.od - c.Ha * b.c))
            : ((d.c = b.c == -t ? -t : c.od - c.Ha * b.c),
                (d.f = b.f == +t ? +t : c.od - c.Ha * b.f));
        Wk(a, b);
    }
    function jl(a, b) {
        function c() {
    ...
    function kl(a, b, c) {
        ...
        d = Tk(a, function (a, b) {
            ...
            f = 0;
            for (c = b.l; null != c; c = c.next)
                if (((e = c.m), (g = Math.abs(e / c.Jc)), c.stat == M))
                    0 > e && f < g && ((d = c), (f = g));
                else if (c.stat == P) 0 < e && f < g && ((d = c), (f = g));
                else return 1;
            null != d &&
            (a.ha == $b && ((a.pa[b.p] = b.stat), (a.oa[d.H] = A)),
                (a.Ea[b.p] = d.m / d.Jc));
            return 0;
        });
        d.p = b.ia;
        ...
        for (g = b.l; null != g; g = g.G)
            if (
                ...
                for (f = f.l; null != f; f = f.L)
                    f != g &&
                    ((k = {}), (k.Ra = f.o.ia), (k.j = f.j), (k.next = e.l), (e.l = k));
        b.c = -t;
        b.f = +t;
        return 0;
    }
    function ll(a) {
        ...
        a.f != +t &&
        ((b = 1e-9 + 1e-12 * Math.abs(a.f)),
        a.f + b < e && (c = a.f - b >= d ? c | 16 : c | 32));
        return c;
    }
    function ml(a, b, c) {
        a.ha == $b &&
        ((a = Tk(a, function (a, b) {
            ...
            (a.p = b.ia),
            (a.stat =
                b.f == +t ? M : b.c == -t ? P : b.c != b.f ? (0 == c ? P : M) : Na));
        0 == c ? (b.c = -t) : 1 == c && (b.f = +t);
    }
    function nl(a) {
        ...
        0 < l &&
        y(l + " integer variable(s) were replaced by " + n + " binary ones");
    ...
    function ol(a, b) {
        var c, d, e;
        d = null;
        for (c = a.l; null != c; c = c.G)
            (e = {}), (e.ja = b * c.j), (e.kc = c.g), (e.next = d), (d = e);
        return d;
    }
    function pl(a, b, c) {
        var d, e, f;
        ...
        f = null;
        for (d = a; null != d; d = d.next)
            d != e && (null == f || Math.abs(f.ja) > Math.abs(d.ja)) && (f = d);
        if (Math.abs(e.ja) + Math.abs(f.ja) <= b + (0.001 + 1e-6 * Math.abs(b)))
            return 0;
        b = 1;
        for (d = a; null != d; d = d.next)
            0 < d.ja ? (d.ja = 1) : ((d.ja = -1), --b);
        c(b);
        return 2;
    }
    function ql(a, b) {
        ...
        for (f = 0; 1 >= f; f++) {
            ...
            if ((1 == f && 1 == c) || 2 == c) {
                ...
                if (b.c == -t || b.f == +t) c = null;
                    ...
                    for (
                        c = Qk(a),
                            0 == f ? ((c.c = b.c), (c.f = +t)) : ((c.c = -t), (c.f = b.f)),
                            d = b.l;
                        null != d;
                        d = d.G
                    )
        ...
        for (f = 0; 1 >= f; f++) {
            ...
            if ((1 == f && 1 == c) || 2 == c) {
                ...
                if (b.c == -t || b.f == +t) c = null;
                    ...
                    for (
                        c = Qk(a),
                            0 == f ? ((c.c = -t), (c.f = b.f)) : ((c.c = b.c), (c.f = +t)),
                            d = b.l;
                        null != d;
                        d = d.G
                    )
    ...
    function tl(a, b, c) {
        ...
        for (d = a; null != d; d = d.next)
            ...
            (0 < d.ja
                ...
                a < b &&
                ((g = b - a),
                0.001 <= g && d.ja - g >= 0.01 * (1 + d.ja) && ((d.ja = g), e++)))
                : ((a = f - d.ja),
                b < a &&
                a < b - d.ja &&
                ((g = d.ja + (a - b)),
    ...
    function wl(a, b, c) {
        ...
        if (b.c != -t) {
            ...
            if (!k) {
                k = b.c;
                for (d = b.l; null != d; d = d.G)
                    d != e && (k = 0 < d.j ? k - d.j * d.g.f : k - d.j * d.g.c);
                if (null == e)
                    for (d = b.l; null != d; d = d.G)
                        d.j >= +g
                            ? (d.g.tb.tb = d.g.f + k / d.j)
                            : d.j <= -g && (d.g.wb.wb = d.g.c + k / d.j);
                else
                    e.j >= +g
                        ? (e.g.tb.tb = k / e.j)
                        : e.j <= -g && (e.g.wb.wb = k / e.j);
            }
        }
        k = !1;
        if (b.f != +t) {
            ...
            if (!k) {
                k = b.f;
                for (d = b.l; null != d; d = d.G)
                    d != e && (k = 0 < d.j ? k - d.j * d.g.c : k - d.j * d.g.f);
                if (null == e)
                    for (d = b.l; null != d; d = d.G)
                        d.j >= +g
                            ? (d.g.wb.wb = d.g.c + k / d.j)
                            : d.j <= -g && (d.g.tb.tb = d.g.f + k / d.j);
                else
                    e.j >= +g
                        ? (e.g.wb.wb = k / e.j)
                        : e.j <= -g && (e.g.tb.tb = k / e.j);
            }
        }
        for (e = b.l; null != e; )
    ...
    function ac(a, b) {
        var c, d, e;
        for (c = a.Fb; null != c; c = d)
            (d = c.next), c.c == -t && c.f == +t && Xk(a, c);
        for (c = a.Fb; null != c; c = d)
            (d = c.next), c.c != -t && c.f != +t && c.c < c.f && $k(a, c);
    ...
    function Tc(a, b) {
        ...
        for (c = a.Oc; null != c; c = d)
            if (
                ((d = c.ga),
                (c.c != -t || c.f != +t) && c.c != c.f && null != c.l && null != c.l.G)
            ) {
                for (
                    f = c.l;
                    null != f && ((e = f.g), e.Ua && 0 == e.c && 1 == e.f);
                    f = f.G
                );
                null == f && (g += ql(a, c));
            }
    ...
    function Ke(a, b, c, d) {
        ...
        if (b) {
            ...
            for (h = 1; h <= b; h++)
                for (n = k[h], g = 1, l = (h - 1) * a.N + 1; g <= b; g++, l++)
                    c[g + d] += e[l] * n;
        } else {
            b = a.n;
            e = a.Pb;
    ...
    var gc = (exports.glp_scale_prob = function (a, b) {
        ...
        function m(a) {
            ...
            for (b = 1; 15 >= b; b++) {
                ...
                v = a;
                for (
                    var H = h, E = void 0, B = (E = void 0), J = void 0, B = 0;
                    1 >= B;
                    B++
                )
                    if (B == H)
                        for (E = 1; E <= v.h; E++)
                            (J = c(v, E) * d(v, E)), Ab(v, E, Cb(v, E) / Math.sqrt(J));
                    else
                        for (E = 1; E <= v.n; E++)
                            (J = e(v, E) * f(v, E)), Bb(v, E, Db(v, E) / Math.sqrt(J));
            }
        }
        b & ~(Uc | Vc | Wc | Xc | hc) &&
        x("glp_scale_prob: flags = " + b + "; invalid scaling options");
        b & hc && (b = Uc | Vc | Xc);
        (function (a, b) {
            function c(a, b, d, e) {
                return (
            ...
            if (
                0.1 <= d &&
                10 >= e &&
                (y("Problem data seem to be well scaled"), b & Xc)
            )
                return;
            b & Uc && (m(a), (d = g(a)), (e = k(a)), y(c("GM", d, e, e / d)));
            b & Vc &&
            (h(a, l(a) > n(a)), (d = g(a)), (e = k(a)), y(c("EQ", d, e, e / d)));
            if (b & Wc) {
    ...
    function Qb(a, b) {
        ...
        function H(a, b) {
            ...
            for (u = 1; u <= q; u++) {
                ...
                0 > B && (B = 0);
                if (D > B || (D == B && w < Math.abs(v)))
                    (m = c), (r = I), (D = B), (w = Math.abs(v));
            }
            if (!(0 == b || 0 >= m || 0 == D))
        ...
        function S(a) {
            ...
            for (w = 1; w <= b; w++) v[w] = 0;
            for (ia = 1; ia <= m; ia++)
                (w = n[ia]), h[g[w]] ? ((v[w] = w = p[w]), (B += w * w)) : (v[w] = 0);
            yd(a.Y, v);
            m = u[l];
            for (ia = 1; ia <= q; ia++)
                if (((a = r[ia]), a != l)) {
                    ...
                    if (n <= b) E = v[n];
                        ...
                        for (E = 0, z = d[n - b], p = d[n - b + 1]; z < p; z++)
                            E -= f[z] * v[e[z]];
                    p = k[a] + w * w * B + 2 * w * E;
                    w = (h[n] ? 1 : 0) + D * w * w;
                    k[a] = p >= w ? p : w;
        ...
        function Z(a, b) {
            ...
            for (d = 1; d <= c; d++) {
                ...
                if (e[m] == Sa || e[m] == Q || e[m] == C)
                    (p = b * (1 + 0.1 * Math.abs(f[m]))),
                    l[d] < f[m] - p && ((h[m] = -1), n++);
                if (e[m] == Ta || e[m] == Q || e[m] == C)
                    (p = b * (1 + 0.1 * Math.abs(g[m]))),
                    l[d] > g[m] + p && ((h[m] = 1), n++);
            }
            return n;
        }
            ...
            for (m = 1; m <= c; m++)
                if (((n = h[m]), 1 == k && 0 > g[n])) {
                    ...
                    if (d[n] == Sa || d[n] == Q || d[n] == C)
                        if (((p = b * (1 + 0.1 * Math.abs(e[n]))), l[m] < e[n] - p))
                            return 1;
                    if (d[n] == Ta || d[n] == Q || d[n] == C)
                        if (((p = b * (1 + 0.1 * Math.abs(f[n]))), l[m] > f[n] + p))
                            return 1;
                }
            return 0;
        }
        function oa(a, b) {
            ...
            for (k = 1; k <= c; k++)
                if (((l = g[k]), 0 > f[l])) {
                    ...
                    0 < f[l] &&
                    ((m = b * (1 + 0.1 * Math.abs(e[l]))), h[k] > e[l] + m)
                )
                    return 1;
            return 0;
        }
        ...
        (function (a, b) {
            ...
            for (w = l = 1; w <= d; w++)
                for (m[w] = l, e = b.g[w].l; null != e; e = e.L)
                    (n[l] = e.o.ia), (p[l] = e.o.qa * e.j * e.g.za), l++;
            m[d + 1] = l;
            ha(I, 1, b.head, 1, c);
            m = 0;
            for (w = 1; w <= c; w++)
                (v = b.o[w]), v.stat != A && (m++, (I[c + m] = w), (q[m] = v.stat));
            for (w = 1; w <= d; w++)
                (v = b.g[w]), v.stat != A && (m++, (I[c + m] = c + w), (q[m] = v.stat));
            a.valid = 1;
            b.valid = 0;
            a.Y = b.Y;
            b.Y = null;
        ...
        for (b.s >= mc && y("Objective scale factor = " + w.eb + ""); ; ) {
            ...
            if (
                ...
                (n(w, w.La),
                    (L = 1),
                0 == w.I &&
                (0 < Z(w, b.Ib) ? (w.I = 1) : (Y(w), (w.I = 2)), (K = 0), F(w, b, 1)),
                    ba(w, b.Ib))
            ) {
                b.s >= Mb &&
                y(
            ...
            var I = w.Ta[w.q],
                ia = T(w);
            if (
                Math.abs(I - ia) > 1e-5 * (1 + Math.abs(ia)) ||
                !((0 > I && 0 > ia) || (0 < I && 0 < ia))
            )
                if (
                    (b.s >= mc && y("d1 = " + I + "; d2 = " + ia + ""), 1 != K || !aa)
                ) {
                    1 != K && (K = 0);
                    aa = 5;
                    continue;
            ...
            if (0 == w.p) {
                ...
                switch (w.I) {
                    case 1:
                        ...
                        break;
                    case 2:
                        b.s >= Xb && y("PROBLEM HAS UNBOUNDED SOLUTION"),
                            D(w, a, ec, jc, w.head[w.h + w.q]),
                            (ea = 0);
                }
                return ea;
            }
            ...
            if (
                ...
                ((I = w.Xa[w.p]),
                    (ia = w.pb[w.q]),
                Math.abs(I - ia) > 1e-8 * (1 + Math.abs(I)) ||
                !((0 < I && 0 < ia) || (0 > I && 0 > ia)))
            ) {
            ...
            (O(w),
                (K = 2),
            1 == w.I && ((I = w.head[w.p]), (w.Ta[w.q] -= w.B[I]), (w.B[I] = 0)));
            if (0 < w.p)
                switch (b.ed) {
                    case oc:
                        0 < w.Ub && S(w);
            ...
            0 < w.p &&
            ((ea = e(w, w.p, w.head[w.h + w.q])),
                (ca = 0 == ea ? 2 : (w.valid = 0)));
            0 < w.p &&
            (h(w, w.q, w.head[w.h + w.q]),
            w.type[w.head[w.p]] != C && k(w, w.q, w.head[w.p]));
            G(w);
            w.da++;
            0 < aa && aa--;
        }
    ...
    function Sb(a, b) {
        ...
        function m(a, b) {
            ...
            for (l = 1; l <= c; l++) {
                ...
                if (d[m] == Sa || d[m] == Q || d[m] == C)
                    (r = b * (1 + 0.1 * Math.abs(e[m]))),
                    h[l] < e[m] - r && (u = e[m] - h[l]);
                if (d[m] == Ta || d[m] == Q || d[m] == C)
                    (r = b * (1 + 0.1 * Math.abs(f[m]))),
                    h[l] > f[m] + r && (u = f[m] - h[l]);
                0 != u &&
                ((m = k[l]),
                ...
                for (n = 1; n <= d; n++)
                    if (k[n] == Na) m[n] = 0;
                        ...
                        if (p <= c) u = -b[p];
                            ...
                            for (q = e[p - c], p = e[p - c + 1], u = 0; q < p; q++)
                                u += b[f[q]] * g[q];
                        0 != u && (l[++r] = n);
                        m[n] = u;
                    }
        ...
        function S(a) {
            ...
            for (e = 1; e <= c; e++)
                (l = h[b + e]), (k[e] = d[l] == C ? Na : 0 <= a[e] ? M : P);
        }
        function G(a) {
            var b = a.h,
                c = a.n,
        ...
        this.chrome_workaround_1 = function (a, b) {
            var c = a.Ga,
                ...
                k;
            for (k = h = 1; k <= f; k++)
                for (c[k] = h, g = b.g[k].l; null != g; g = g.L)
                    (d[h] = g.o.ia), (e[h] = g.o.qa * g.j * g.g.za), h++;
            c[f + 1] = h;
        };
        this.chrome_workaround_2 = function (a, b) {
            var c,
                ...
                k = a.h;
            for (d = c = 1; d <= k; d++)
                for (f[d] = c, e = b.o[d].l; null != e; e = e.G)
                    (g[c] = e.g.H), (h[c] = e.o.qa * e.j * e.g.za), c++;
            f[k + 1] = c;
        };
        var z,
            F = 2,
        ...
        (function (a, b) {
            ...
            h = 0;
            for (v = 1; v <= c; v++)
                (z = b.o[v]), z.stat != A && (h++, (p[c + h] = v), (r[h] = z.stat));
            for (v = 1; v <= d; v++)
                (z = b.g[v]), z.stat != A && (h++, (p[c + h] = c + v), (r[h] = z.stat));
        ...
        for (b.s >= mc && y("Objective scale factor = " + z.eb + ""); ; ) {
            ...
            if (
                ...
                (l(z),
                    (w = 1),
                0 == z.I &&
                (0 != O(z, 0.9 * b.vb) ? ((z.I = 1), S(z)) : ((z.I = 2), G(z)),
                    (D = z.Ub = 0)),
                0 != Z(z, b.vb))
            ) {
                b.s >= Mb &&
            ...
            ea = z.pb[z.q];
            if (
                Math.abs(da - ea) > 1e-8 * (1 + Math.abs(da)) ||
                !((0 < da && 0 < ea) || (0 > da && 0 > ea))
            ) {
